...
This prompt covers targets 136-150 from the current unrepaired low-confidence opportunity-data queue after GPT Pro repair batches 1-18, excluding in-flight prompt batches 19-23. Do not add other opportunities. Do not skip any target unless you mark it source_inaccessible or unknown inside its repair object.
...
- continueFromOpportunityId is "SOURCE_DSIRE:dsire_program_id:3721".
