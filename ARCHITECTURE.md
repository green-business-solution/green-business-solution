...
The `gbs-contractors` DynamoDB table stores the standardized one-time CSLB contractor import and supports guarded missing-field enrichment from official directories.
The private contractor-source bucket stores the unchanged CSLB source, reviewed official-directory snapshots, import manifests, and aggregate reports.
