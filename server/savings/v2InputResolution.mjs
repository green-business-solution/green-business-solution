...
const SYNTHETIC_DEFAULTS = {
  ...
  interstate_or_foreign_sales_deductions_cents: 0,
  multiple_activities_tax_credit_adjustments: 0,
  multiple_activities_tax_credit_adjustments_cents: 0,
  deductions_or_credits: 0,
  qualifying_taxable_gross_receipts: 10000000,
  qualifying_taxable_gross_receipts_cents: 10000000,
  qualifying_tax_base_after_deductions_and_matc_cents: 10000000,
  annual_tax_performance_report_filed: true,
  approvedzonedesignation: true,
  approved_rerz_designation: true,
  qualifiedcompanyoperations: true,
  qualified_company_operations: true,
  company_current_on_state_and_local_taxes: true,
  zonetermyears: 15,
  approved_zone_term_years: 15,
  programyear: 1,
  program_year: 1,
  eligiblestateeducationtaxcents: 0,
  eligible_state_education_tax_cents: 0,
  eligiblerealpropertytaxcents: 0,
  eligible_real_property_tax_cents: 0,
  eligiblepersonalpropertytaxcents: 0,
  eligible_personal_property_tax_cents: 0,
  eligiblelocalincometaxcents: 0,
  eligible_local_income_tax_cents: 0,
  phaseout_multiplier: 1,
  phaseoutschedule: "none",
  eligibletaxliabilitybytype: "synthetic tax profile",
  ac_kw_capacity: 100,
  renewable_resource_type: "solar",
  municipality: "synthetic_rhode_island_municipality",
  commercial_tax_status: "commercial",
  tangible_property_applicable: true,
  real_property_applicable: true,
  municipal_exemption_or_waiver_status: "not_confirmed",
  residential_system_exemption: false,
