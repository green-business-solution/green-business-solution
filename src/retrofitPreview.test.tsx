...
describe("retrofit recommendations preview", () => {
  ...
  it("renders the admin-nav user preview structure", () => {
    ...
    expect(html).not.toContain("Included incentives");
    ...
    expect(html.indexOf("overview-workspace-panel")).toBeLessThan(html.indexOf("aria-label=\"Confirm retrofit plan\""));
  ...
  it("keeps preview hover and active states readable and visually distinct", async () => {
    ...
    expect(css).not.toContain("height: 118px");
