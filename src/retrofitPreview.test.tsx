...
describe("retrofit recommendations preview", () => {
  ...
  it("renders the selected retrofit estimate workspace with the new tab set and safety gates", async () => {
    ...
    expect(workspaceSource).toContain("View full application support");
    expect(workspaceSource).toContain("Confirm & move to next step");
    expect(workspaceSource).toContain("Download estimate");
    expect(workspaceSource).toContain("PDF summary");
