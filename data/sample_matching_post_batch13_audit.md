...
Generated: 2026-07-02T00:18:17.467Z
Sample cases: 50
...
- Opportunity data issues: 200
- Matching/ranking issues: 208
- Pending GPT target top-result rows: 50
- Unrepaired low-confidence top-result rows: 150
...
- Energy Innovation Grant Program (SOURCE_DSIRE:dsire_program_id:22074): 2 appearances, 0 rank-1, not in next target list; unrepaired_low_confidence_opportunity_data=2
...
- Local Option - County Energy District Authority (SOURCE_DSIRE:dsire_program_id:3534): 2 appearances, 0 rank-1, not in next target list; non_physical_top_result=2, planning_or_certification_high_rank=2, unrepaired_low_confidence_opportunity_data=2
...
- california-endowment-hq: 10 flagged top results (7 data, 5 ranking)
- ikea-burbank: 10 flagged top results (7 data, 5 ranking)
- melissas-vernon-distribution: 10 flagged top results (7 data, 5 ranking)
- northgate-market-anaheim: 10 flagged top results (7 data, 5 ranking)
- one-community-health-midtown: 10 flagged top results (6 data, 6 ranking)
- westin-pasadena: 10 flagged top results (7 data, 5 ranking)
...
- gm-factory-zero-detroit: 8 flagged top results (4 data, 6 ranking)
- kauai-coffee-kalaheo: 8 flagged top results (6 data, 4 ranking)
- boeing-everett-factory: 7 flagged top results (5 data, 4 ranking)
- boston-latin-school: 7 flagged top results (7 data, 2 ranking)
- common-ground-coop-urbana: 7 flagged top results (5 data, 5 ranking)
- eastern-market-detroit: 7 flagged top results (3 data, 7 ranking)
- hersheys-chocolate-world-hershey: 7 flagged top results (5 data, 5 ranking)
- qts-richmond-data-center: 7 flagged top results (1 data, 6 ranking)
- quaker-oats-cedar-rapids: 7 flagged top results (4 data, 5 ranking)
- santa-clara-university-campus: 7 flagged top results (5 data, 6 ranking)
- seghesio-healdsburg-winery: 7 flagged top results (6 data, 5 ranking)
