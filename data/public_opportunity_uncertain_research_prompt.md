...
```json
{
  "fetched_but_no_supported_status": 7,
  "source_missing_404": 43
}
```

## Targets

### 1. Southwest Gas Corporation - Combined Heat and Power Program
...
```json
{
  ...
  "checkedUrls": [
    "https://www.swgas.com/en/rebates-and-promotions-search-residential-arizona",
    "https://www.swgas.com/1409181751727/F915-09-Arizona-Smarter-Greener-Better-Distributed-Generation-Program-Rebate-Application.pdf",
    "https://www.swgas.com/1409210069209/230531-APP-23-XXXX-SWG-2023-EE-RET-Application-.pdf"
  ],
  "fetchErrors": [],
  "currentEvidenceText": "A current official Southwest Gas source confirming the Arizona Combined Heat and Power Program as open could not be verified.",
  "currentReasons": [
    "still_uncertain"
  ],
...
### 2. Sulphur Springs Valley EC - SunWatts Rebate Program
...
```json
{
  ...
  "checkedUrls": [
    "https://www.ssvec.org/downloads/programs/renewable/2022/2022-SunWatts-Handbook.pdf",
    "https://www.ssvec.org/downloads/programs/renewable/2022/The-SunWatts-Solar-Water-Heating.pdf",
    "https://www.ssvec.org/programs/rebates.php"
  ],
  "fetchErrors": [],
  "currentEvidenceText": "Current official Sulphur Springs Valley EC rebate pages did not safely confirm the SunWatts rebate program as currently open.",
  "currentReasons": [
    "still_uncertain"
  ],
  "failureBucket": "fetched_but_no_supported_status"
...
### 3. Trico Electric Cooperative  - SunWatts Incentive Program
...
```json
{
  ...
  "checkedUrls": [
    "https://trico.coop/sustainable-programs/solar/",
    "https://trico.coop/wp-content/uploads/2026/01/RESFM.pdf"
  ],
  "fetchErrors": [],
  "currentEvidenceText": "Current Trico solar and renewable materials did not safely confirm an active SunWatts incentive program.",
  "currentReasons": [
    "still_uncertain"
  ],
  "failureBucket": "fetched_but_no_supported_status"
...
### 4. New Smyrna Beach - Energy Efficiency Rebate Program
...
```json
{
  ...
  "fetchErrors": [],
  "currentEvidenceText": "A current official New Smyrna Beach Utilities source confirming this specific rebate program could not be verified.",
  "currentReasons": [
    "still_uncertain"
  ],
  "failureBucket": "fetched_but_no_supported_status"
...
```json
{
  ...
  "fetchErrors": [],
  "currentEvidenceText": "A current official North Branch or SMMPA source confirming this specific commercial and industrial rebate program could not be verified.",
  "currentReasons": [
    "still_uncertain"
  ],
  "failureBucket": "fetched_but_no_supported_status"
...
### 7. Wyoming PACE Financing Program
...
```json
{
  ...
  "websiteUrl": null,
  "checkedUrls": [
    "https://programs.dsireusa.org/system/program/detail/4914/wyoming-pace-financing-program",
    "https://www.epa.gov/statelocalenergy/commercial-property-assessed-clean-energy"
  ],
  "fetchErrors": [],
  "currentEvidenceText": "A current official Wyoming administrator or statutory source confirming active PACE financing availability could not be verified.",
