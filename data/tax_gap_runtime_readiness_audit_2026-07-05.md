...
Generated at: 2026-07-05T03:39:56.401Z
...
| ready_internal_only_runtime_gated | 7 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| vernon_ca_partial_local_tax_sources_skip_until_code_verified_v1 | local_business_license_or_receipts_tax | City of Vernon, California | compiled_to_local_tax_workflow | needs_tax_profile | 1 | 1 | ready_internal_only_runtime_gated |
...
| sales_use_tax_ambiguous_rule_4 | sales_use_tax_exemption | IA | generic_runtime_model_supported_gated | needs_tax_profile | 1 | 1 | ready_internal_only_runtime_gated |
...
| sales_use_tax_ambiguous_rule_8 | gross_receipts_or_bo_rate_preference | NM | compiled_to_local_tax_workflow | needs_filing_confirmation | 1 | 1 | ready_internal_only_runtime_gated |
| az_renewable_energy_production_tax_credit_skip_v1 | state_income_or_franchise_tax_credit | AZ | generic_runtime_model_supported_gated | needs_filing_confirmation | 3 | 1 | ready_internal_only_runtime_gated |
| co_heat_pump_systems_registered_contractor_credit_skip_v1 | state_income_or_franchise_tax_credit | CO | generic_runtime_model_supported_gated | needs_filing_confirmation | 3 | 1 | ready_internal_only_runtime_gated |
| ct_green_buildings_credit_skip_v1 | state_income_or_franchise_tax_credit | CT | generic_runtime_model_supported_gated | needs_program_documentation | 2 | 1 | ready_internal_only_runtime_gated |
...
| skip_oh_cat_current_exclusion_amount_without_current_return_confirmation | gross_receipts_or_bo_rate_preference | OH | compiled_to_local_tax_workflow | needs_tax_return | 1 | 1 | ready_internal_only_runtime_gated |
...
- 19 candidate(s) now have at least one matching test profile with all audited runtime inputs present. These are still internal-only until runtime importer and customer-facing inclusion policy are explicitly enabled.
