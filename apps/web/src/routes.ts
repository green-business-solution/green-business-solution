...
export function routePathMatchFromPath(
  ...
  if (pathname === "/about/team")
    return { isKnownPath: true, route: "about-team" };
  if (pathname === "/about/trust")
    return { isKnownPath: true, route: "about-trust" };
  if (pathname === "/about/contact")
    return { isKnownPath: true, route: "about-contact" };
  if (pathname === "/scan" || pathname === "/get-started")
    return { isKnownPath: true, route: "scan" };
  if (pathname === "/scan/results")
    return { isKnownPath: true, route: "scan-results" };
  if (pathname === "/scan/energy-data")
    return { isKnownPath: true, route: "scan-energy-data" };
  if (pathname === "/sign-in") return { isKnownPath: true, route: "sign-in" };
  if (pathname === "/portal") return { isKnownPath: true, route: "portal" };
  if (pathname === "/portal-preview")
  ...
  if (pathname === "/admin/application-sources")
    return { isKnownPath: true, route: "admin-application-sources" };
  if (pathname === "/admin/application-profiles")
    return { isKnownPath: true, route: "admin-application-profiles" };
  if (pathname === "/admin") return { isKnownPath: true, route: "admin" };
  if (pathname === "/testcases")
    return { isKnownPath: true, route: "testcases" };
...
export function pathForRoute(route: Route) {
  ...
  if (route === "admin-application-sources")
    return "/admin/application-sources";
  if (route === "admin-dashboard-performance-data")
    return "/admin/dashboard-performance-data";
  if (route === "admin-application-profiles")
