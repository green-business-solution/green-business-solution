...
describe("retrofit recommendations preview", () => {
  ...
  it("renders the selected retrofit estimate workspace with the new tab set and safety gates", async () => {
    ...
    expect(workspaceSource).toContain("opportunity-view-toggle");
    expect(workspaceSource).toContain("opportunity-review-layout");
    expect(source).toContain("opportunity-review-detail-panel");
    expect(workspaceSource).toContain("renderOpportunityDetailPanel");
    ...
    expect(source).toContain("[\"tradeoffs\", \"Tradeoffs\"]");
    expect(source).toContain("[\"summary\", \"Summary\"]");
    expect(source).toContain("[\"review\", \"Review\"]");
    expect(source).toContain("[\"guided\", \"Guided\"]");
    expect(workspaceSource).toContain("showScenarioMatrix");
    expect(workspaceSource).toContain("showScenarioTradeoffs");
    expect(workspaceSource).toContain("showScenarioSummary");
    expect(workspaceSource).toContain("showScenarioReview");
    expect(workspaceSource).toContain("showScenarioGuided");
    ...
    expect(workspaceSource).toContain("scenario-summary-preview");
    expect(workspaceSource).toContain("Optional opportunity adjustments");
    expect(workspaceSource).toContain("scenario-review-preview");
