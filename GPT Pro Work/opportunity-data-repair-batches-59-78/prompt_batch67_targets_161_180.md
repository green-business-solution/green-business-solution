...
This prompt covers targets 161-180 from the current unrepaired low-confidence opportunity-data queue after GPT Pro repair batches 1-58. Do not add other opportunities. Do not skip any target unless you mark it source_inaccessible or unknown inside its repair object.
...
- continueFromOpportunityId is "SOURCE_DSIRE:dsire_program_id:389".
