  ...
  "retrofits": [
    {
      ...
      "matchedOpportunities": [
        ...
        },
        {
          ...
          "programType": "Industry Support Tax Credit",
          ...
          "applicationUrl": "https://www.michigan.gov/taxes/-/media/Project/Websites/taxes/Forms/MBT/TY2025/4573_ty2025.pdf",
          "matchedReasons": [
            "Opportunity appears rolling or no-deadline.",
            ...
            "Applicant type overlaps eligible sector: nonprofit.",
            "User site is compatible with broad commercial facility eligibility.",
            "Opportunity technology is available for retrofit discovery: solar, battery_storage, renewable_energy, wind, biomass_biogas, fleet_electrification, clean_transportation, fuel_cell_system."
          ],
          "unresolvedRequirements": [],
          "blockers": [
          ...
          "hardRequirements": [
            ...
            "Qualified activity must be research, development, or manufacturing of an alternative energy marine propulsion system, alternative energy system, alternative energy vehicle, alternative energy technology, or renewable ...",
    ...
    },
    {
      ...
      "matchedOpportunities": [
        ...
        },
        {
          ...
          "eligibilityStatus": "eligible",
          "availabilityStatus": "active",
          "programType": "Commercial Loan And Financing Program",
          ...
          "matchedReasons": [
            ...
            "Applicant type overlaps eligible sector: nonprofit.",
            "User site is compatible with broad commercial facility eligibility.",
            "Opportunity technology is available for retrofit discovery: solar, hvac, building_envelope, lighting, building_controls, commercial_kitchen, refrigeration, energy_efficiency."
          ],
          "unresolvedRequirements": [],
          "blockers": [
            "Do not present the program as a rebate or guaranteed incentive payment.",
            "Solar thermal water heating was not verified on the current commercial-loans page; solar support observed was solar photovoltaic.",
            "Ground-source geothermal and air sealing were not directly verified on the current public page checked and should not be matched unless the full eligible-improvements list confirms them.",
            "Financing approval, contractor authorization and lender terms can block otherwise eligible equipment."
          ],
          "hardRequirements": [
            "This is financing through Michigan Saves authorized contractors and participating lenders, not a rebate.",
            "Borrower, project and contractor must satisfy Michigan Saves and lender underwriting requirements.",
            "Commercial financing generally starts at the program’s minimum loan size and rates, terms and prefunding depend on the lender.",
            "Interest-rate buy-downs are limited to qualifying commercial or municipal customers of participating utilities and eligible improvements.",
            "Eligible improvements must be on Michigan Saves’ commercial improvements list or otherwise approved by the program."
          ],
          "eligibleApplicantTypes": [
            "business_customer",
          ...
          "eligibleRetrofitCategories": [
            ...
            "energy_star_roofing",
            "efficient_ecm_motor_retrofit"
          ],
          "evidenceText": "Michigan]( Saves’ commercial financing page lists loans for HVAC, roofing, LED lighting, occupancy sensors, commercial kitchen equipment, water heaters, boilers, solar PV, EV chargers and related efficiency improvements.",
          "reasoningNotes": "Converted the record from rebate-style matching to financing support. Removed unverified solar thermal and flagged geothermal or air sealing for separate confirmation from the detailed improvements list."
        },
        {
          "opportunityId": "SOURCE_DSIRE:dsire_program_id:676",
          "opportunityName": "Modified Accelerated Cost-Recovery System (MACRS)",
      ...
      "matchedOpportunities": [
        {
          ...
          "administrator": "Lean and Green Michigan and participating local governments",
          "state": "MI",
          "rankScore": 100,
          "matchConfidence": 1,
          "opportunityDataConfidence": 0.82,
          ...
          "matchedReasons": [
            ...
            "Nonresidential applicant is compatible with broad commercial eligibility.",
            "User site is compatible with broad nonresidential facility eligibility.",
            "Opportunity technology is available for retrofit discovery: energy_efficiency, renewable_energy, solar, ev_charging."
          ],
          "unresolvedRequirements": [],
          "blockers": [
            "Do not treat PACE financing as a rebate or grant.",
            "Do not match residential single-family properties unless the governing local PACE program explicitly allows them.",
            "Do not match EV charging unless financed as an eligible improvement under the local PACE program."
          ],
          "hardRequirements": [
            "Property must be privately owned and located in a participating Michigan PACE jurisdiction.",
            "Project must qualify under Michigan PACE as an eligible energy, water, renewable, environmental hazard, or related improvement.",
            "Financing must be approved and repaid through the property assessment structure."
          ],
          "eligibleApplicantTypes": [
            "commercial_property_owner",
          ...
          "eligibleRetrofitCategories": [
            ...
            "water_conservation_measure",
            "environmental_hazard_project",
            "ev_charger_installation"
          ],
          "evidenceText": "Lean]( and Green Michigan’s program manual describes commercial PACE financing for energy, renewable energy, water, and environmental hazard improvements in participating jurisdictions; an official case study includes EV charging in a financed project.",
          "reasoningNotes": "The EV charging match is valid only as a financeable PACE improvement. The program should be represented as financing, not as a direct EV charger rebate."
        }
      ],
      "v2PackageSummaries": []
    },
