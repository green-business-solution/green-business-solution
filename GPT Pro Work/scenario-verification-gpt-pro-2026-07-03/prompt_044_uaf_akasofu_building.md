      ...
      "matchedOpportunities": [
        ...
        },
        {
          ...
          "matchedReasons": [
            ...
            "Opportunity technology is available for retrofit discovery: solar, renewable_energy, wind, biomass_biogas, energy_efficiency, battery_storage."
          ],
          "unresolvedRequirements": [],
          "blockers": [
            "Do not match individual homeowner or ordinary commercial building retrofit projects.",
            "Do not match ground-source geothermal heat pumps for space conditioning.",
            "Do not match standalone customer battery storage systems.",
            "Biomass or geothermal should only match if part of a qualifying electric power facility project.",
            "This is a loan fund, not a rebate."
          ],
          "hardRequirements": [
            "Project must involve development, expansion, or upgrade of qualifying electric power facilities.",
            "Eligible borrowers include local utilities, local governments, and independent power producers.",
            "Loan term is tied to the productive life of the project and cannot exceed 50 years.",
            "Application fees, financial review, and Alaska Energy Authority approval apply.",
            "Loans over 5000000 dollars require legislative authorization to apply."
          ],
          "eligibleApplicantTypes": [
            "local_utility",
            "local_government",
          ...
          "eligibleRetrofitCategories": [
            "electric_power_facility_financing",
            "distribution_transmission_upgrade_financing",
            "utility_energy_efficiency_or_conservation_project_financing",
            "bulk_fuel_storage_or_waste_energy_project_financing"
          ],
          "evidenceText": "Alaska Energy Authority describes the Power Project Fund as loans for electric power facility development, expansion, or upgrades, including distribution, transmission, efficiency, conservation, and related infrastructure.",
          "reasoningNotes": "The original biomass, geothermal heat pump, and battery storage retrofit matches overgeneralize a utility-scale power facility loan fund."
        },
        {
      ...
      "v2PackageSummaries": [
        {
          ...
          "missingInputs": [
            {
              "inputKey": "conditional_award_amount",
              "effectId": "effect_grant_expected_value_1_eff91e0ede6cdd5f",
              "label": "conditional_award_amount"
            }
          ],
          "requiredInputs": [
      ...
      "matchedOpportunities": [
        {
          ...
          "matchedReasons": [
            ...
            "Applicant type overlaps eligible sector: government.",
            "No site or facility type restriction was found after source review.",
            "Opportunity technology is available for retrofit discovery: energy_efficiency, renewable_energy, solar."
          ],
          "unresolvedRequirements": [],
          "blockers": [
            "Not available for private commercial, residential, or nonprofit buildings outside the listed public borrowers.",
            "The audit is required to define eligible measures; it is not a separate open-ended audit grant.",
            "Only permanent energy-efficiency improvements are eligible."
          ],
          "hardRequirements": [
            "Facility must be owned by an eligible Alaska public borrower.",
            "Borrower must obtain an Investment Grade Audit.",
            "Loan-financed improvements must be identified in the approved audit.",
            "Savings must be sufficient to repay debt service under program underwriting.",
            "Improvements must be completed within 365 days after loan closing."
          ],
          "eligibleApplicantTypes": [
            "regional_educational_attendance_area",
            "state_government",
            "municipality",
            "public_university"
          ],
          ...
          "eligibleRetrofitCategories": [
            "investment_grade_energy_audit",
            "public_building_energy_efficiency_improvements"
          ],
          "evidenceText": "AHFC states that borrowers must obtain an Investment Grade Audit and may finance only permanent efficiency improvements identified in that audit.",
          "reasoningNotes": "The audit match is source-backed but should be narrowed to investment-grade audit requirements for eligible public facilities."
        }
      ],
      "v2PackageSummaries": []
    },
