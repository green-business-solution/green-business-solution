  ...
  "retrofits": [
    {
      ...
      "matchedOpportunities": [
        ...
        },
        {
          ...
          "matchedReasons": [
            "Opportunity appears active.",
            "Project site state CA matches opportunity geography.",
            "Self-reported utility matches SMUD.",
            "Nonresidential applicant is compatible with broad commercial eligibility.",
            "User site is compatible with broad commercial facility eligibility.",
            "Opportunity technology is available for retrofit discovery: ev_charging."
          ],
      ...
      "v2PackageSummaries": [
        {
          "opportunityId": "SOURCE_DSIRE:dsire_program_id:22290",
          "programName": "SMUD - Commercial Electric Vehicle Incentive Program",
          ...
          "requiredInputs": [
            "charger_type",
            "power_kw",
            "handle_or_outlet_count",
            "equity_project_status",
            "integrated_storage_kwh"
          ],
          "defaultedInputs": [
            {
            ...
            {
              "inputKey": "handle_or_outlet_count",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            },
            {
              "inputKey": "equity_project_status",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            },
            {
              "inputKey": "integrated_storage_kwh",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            }
          ...
          "totals": {
            "expectedOneTimeSavingsCents": 250000,
          ...
          "effectSummaries": [
            {
              "effectId": "effect_one_time_savings_1_75881f52402a1475",
    ...
    },
    {
      ...
      "matchedOpportunities": [
        ...
        },
        {
          ...
          "matchedReasons": [
            ...
            "Nonresidential applicant is compatible with broad commercial eligibility.",
            "User site is compatible with broad commercial facility eligibility.",
            "Opportunity technology is available for retrofit discovery: energy_efficiency."
          ],
          "unresolvedRequirements": [],
          "blockers": [
      ...
      "v2PackageSummaries": [
        {
          "opportunityId": "SOURCE_DSIRE:dsire_program_id:1917",
          "programName": "SMUD - Commercial Energy Efficiency Rebate Program",
          "calculationStatus": "calculable_with_missing_inputs",
          "runtimeInclusionStatus": "not_user_facing_default",
          "includedInRuntimeTotals": false,
          "confidence": "medium",
          ...
          "requiredInputs": [
            ...
            "replacement_status",
            "custom_track",
            "annual_kwh_or_kwh_equivalent_reduction",
            "eligible_project_cost",
            "preapproval_status",
          ...
          "defaultedInputs": [
            ...
            {
              "inputKey": "gas_replacement_status",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            },
            ...
            {
              "inputKey": "custom_track",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            },
            {
              "inputKey": "annual_kwh_or_kwh_equivalent_reduction",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            },
          ...
          "totals": {
            "expectedOneTimeSavingsCents": 525000,
            "expectedGrantAmountCents": 0,
            "expectedRecurringSavingsAnnualCents": 0,
            "expectedRecurringExpensesAnnualCents": 0,
            "annualNetRecurringBenefitCents": 0
          ...
          "effectSummaries": [
            {
              "effectId": "effect_one_time_savings_1_10f338411a0b3da3",
              "effectType": "one_time_savings",
            ...
            {
              "effectId": "effect_one_time_savings_2_de91933cf2aabab0",
              "effectType": "one_time_savings",
              "calculationMethod": "rate_table",
              "valueModelKind": "hybrid_rate_plus_cap",
              "cashValueClassification": "rebate",
      ...
      "v2PackageSummaries": [
        {
          ...
          "totals": {
            "expectedOneTimeSavingsCents": 155000,
            "expectedGrantAmountCents": 0,
            "expectedRecurringSavingsAnnualCents": 0,
            "expectedRecurringExpensesAnnualCents": 0,
            "annualNetRecurringBenefitCents": 0
