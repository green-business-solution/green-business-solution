    ...
    },
    {
      ...
      "matchedOpportunities": [
        ...
        },
        {
          ...
          "matchedReasons": [
            "Opportunity appears active.",
            "Project site state IA matches opportunity geography.",
            "Self-reported utility matches Alliant Energy / Interstate Power and Light.",
            "Applicant type overlaps eligible sector: industrial.",
            "User site is compatible with broad nonresidential facility eligibility.",
      ...
      "v2PackageSummaries": [
        {
          "opportunityId": "SOURCE_DSIRE:dsire_program_id:4971",
          "programName": "Alliant Energy Interstate Power and Light - Commercial and Industrial Energy Efficiency Rebate Program",
          ...
          "defaultedInputs": [
            ...
            {
              "inputKey": "selected_equipment_tier",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            },
            {
              "inputKey": "capacity_or_quantity",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            }
          ...
          "effectSummaries": [
            {
              "effectId": "effect_one_time_savings_1_50a93052a5a24260",
      ...
      "matchedOpportunities": [
        {
          ...
          "matchedReasons": [
            ...
            "Nonresidential applicant is compatible with broad commercial eligibility.",
            "Site or facility type is not applicable to this opportunity.",
            "Opportunity technology is available for retrofit discovery: building_controls, energy_efficiency, renewable_energy, solar."
          ],
          "unresolvedRequirements": [],
          "blockers": [
