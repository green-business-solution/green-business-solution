...
Packet 4 of 50:
{
  ...
  "userProfile": {
    ...
    "site": {
      "address": {
        "raw": "2030 E Lincoln Avenue, Anaheim, CA 92806, USA",
        "stateCode": "CA",
        "zip5": "92806"
      },
      "geo": {
  ...
  "retrofits": [
    {
      ...
      "matchedOpportunities": [
        ...
        },
        {
          ...
          "matchedReasons": [
            "Opportunity appears active.",
            "Project site state CA matches opportunity geography.",
            "Self-reported utility matches Anaheim Public Utilities.",
            "Applicant type overlaps eligible sector: commercial.",
            "User site is compatible with broad commercial facility eligibility.",
        ...
        },
        {
          ...
          "matchedReasons": [
            ...
            "Applicant type overlaps eligible sector: commercial.",
            "User site is compatible with broad commercial facility eligibility.",
            "Opportunity technology is available for retrofit discovery: hvac, ev_charging, lighting, refrigeration, energy_efficiency."
          ],
          "unresolvedRequirements": [],
          "blockers": [
            "cooling_tower_controls_optimization is eligible only where supported as a custom electric-savings project or through a separate water-efficiency pathway; do not auto-match all cooling tower water projects to the energ...",
          ...
          "hardRequirements": [
            ...
            "Customized energy incentives require APU review, savings calculations, and approval; examples include chillers, cooling towers, compressed air, air handler units, refrigeration systems, building envelope, process equi...",
      ...
      "v2PackageSummaries": [
        {
          "opportunityId": "SOURCE_DSIRE:dsire_program_id:1615",
          "programName": "Anaheim Public Utilities - Commercial Energy Efficiency Rebate Programs",
          ...
          "defaultedInputs": [
            ...
            {
              "inputKey": "ev_public_access_status",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            },
            {
              "inputKey": "ev_site_type",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            }
          ...
          "totals": {
            "expectedOneTimeSavingsCents": 450000,
          ...
          "effectSummaries": [
            {
              "effectId": "effect_one_time_savings_1_31f721698e50c12d",
        ...
        {
          "opportunityId": "SOURCE_DSIRE:dsire_program_id:22277",
          "programName": "Anaheim Public Utilities - EV Fleet Charger and Infrastructure Rebate",
          ...
          "requiredInputs": [
            "applicant_type",
            "charger_count",
            "eligible_charger_and_infrastructure_cost",
            "submeter_installation_cost",
            "city_plan_check_fees",
            "electric_service_connection_fees",
            "approval_letter_status",
            "fleet_vehicle_documentation"
          ],
          "defaultedInputs": [
            {
              "inputKey": "charger_count",
            ...
            {
              "inputKey": "eligible_charger_and_infrastructure_cost",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            },
            {
              "inputKey": "submeter_installation_cost",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            },
            {
              "inputKey": "city_plan_check_fees",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            },
            {
              "inputKey": "electric_service_connection_fees",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            },
            {
              "inputKey": "approval_letter_status",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            },
            {
              "inputKey": "fleet_vehicle_documentation",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            }
          ...
          "effectSummaries": [
            {
              "effectId": "effect_one_time_savings_1_c4668afb0e759bc5",
              "effectType": "one_time_savings",
        ...
        {
          "opportunityId": "SOURCE_DSIRE:dsire_program_id:22275",
          "programName": "Anaheim Public Utilities - Personal Use EV Charger Rebates",
          "calculationStatus": "calculable_with_missing_inputs",
          "runtimeInclusionStatus": "not_user_facing_default",
          "includedInRuntimeTotals": false,
          "confidence": "high",
          "missingInputs": [],
          "requiredInputs": [
            "charger_networked_status",
            "time_of_use_rate_enrollment",
            "eligible_charger_equipment_cost",
          ...
          "defaultedInputs": [
            {
              "inputKey": "charger_networked_status",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            },
            {
              "inputKey": "time_of_use_rate_enrollment",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            },
            {
              "inputKey": "eligible_charger_equipment_cost",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            },
          ...
          "effectSummaries": [
            {
              "effectId": "effect_one_time_savings_1_c48ec7ea9decc94f",
              "effectType": "one_time_savings",
              "calculationMethod": "zero_when_not_applicable",
              "valueModelKind": "hybrid_rate_plus_cap",
              "cashValueClassification": "rebate",
      ...
      "matchedOpportunities": [
        ...
        },
        {
          ...
          "matchedReasons": [
            ...
            "Applicant type overlaps eligible sector: commercial.",
            "User site is compatible with broad commercial facility eligibility.",
            "Opportunity technology is available for retrofit discovery: hvac, lighting, water_efficiency, building_controls."
          ],
          "unresolvedRequirements": [],
          "blockers": [
      ...
      "v2PackageSummaries": [
        {
          ...
          "totals": {
            "expectedOneTimeSavingsCents": 120319,
            "expectedGrantAmountCents": 0,
            "expectedRecurringSavingsAnnualCents": 0,
            "expectedRecurringExpensesAnnualCents": 0,
            "annualNetRecurringBenefitCents": 0
        ...
        {
          "opportunityId": "SOURCE_DSIRE:dsire_program_id:1625",
          "programName": "Anaheim Public Utilities - Small Business Energy & Water Direct Install Program",
          ...
          "missingInputs": [],
          "requiredInputs": [
            "program_assessment_results",
            "recommended_energy_measures",
            "recommended_water_measures",
            "approved_direct_install_allowance",
            "customer_cost_share_if_any",
            "assessment_results",
          ...
          "defaultedInputs": [
            {
              "inputKey": "program_assessment_results",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            },
            {
              "inputKey": "recommended_energy_measures",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            },
            {
              "inputKey": "recommended_water_measures",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            },
            {
              "inputKey": "approved_direct_install_allowance",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            },
            {
              "inputKey": "customer_cost_share_if_any",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            },
            {
              "inputKey": "assessment_results",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            },
          ...
          "effectSummaries": [
            {
              "effectId": "effect_process_value_1_0d47df7054e7768f",
      ...
      "v2PackageSummaries": [
        {
          ...
          "totals": {
            "expectedOneTimeSavingsCents": 675000,
            "expectedGrantAmountCents": 0,
            "expectedRecurringSavingsAnnualCents": 0,
            "expectedRecurringExpensesAnnualCents": 0,
            "annualNetRecurringBenefitCents": 0
      ...
      "v2PackageSummaries": [
        {
          ...
          "totals": {
            "expectedOneTimeSavingsCents": 187500,
            "expectedGrantAmountCents": 0,
            "expectedRecurringSavingsAnnualCents": 0,
            "expectedRecurringExpensesAnnualCents": 0,
            "annualNetRecurringBenefitCents": 0
      ...
      "v2PackageSummaries": [
        {
          ...
          "totals": {
            "expectedOneTimeSavingsCents": 67500,
            "expectedGrantAmountCents": 0,
            "expectedRecurringSavingsAnnualCents": 0,
            "expectedRecurringExpensesAnnualCents": 0,
            "annualNetRecurringBenefitCents": 0
      ...
      "v2PackageSummaries": [
        {
          ...
          "totals": {
            "expectedOneTimeSavingsCents": 112500,
            "expectedGrantAmountCents": 0,
            "expectedRecurringSavingsAnnualCents": 0,
            "expectedRecurringExpensesAnnualCents": 0,
            "annualNetRecurringBenefitCents": 0
