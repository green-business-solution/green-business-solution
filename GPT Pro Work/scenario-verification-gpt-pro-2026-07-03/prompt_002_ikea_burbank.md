...
Packet 2 of 50:
{
  ...
  "userProfile": {
    ...
    "site": {
      "address": {
        "raw": "600 South IKEA Way, Burbank, CA 91502, USA",
        "stateCode": "CA",
        "zip5": "91502"
      },
      "geo": {
  ...
  "retrofits": [
    ...
    },
    {
      ...
      "matchedOpportunities": [
        ...
        },
        {
          ...
          "matchedReasons": [
            "Opportunity appears active.",
            "Project site state CA matches opportunity geography.",
            "Self-reported utility matches Burbank Water and Power.",
            "Applicant type overlaps eligible sector: commercial.",
            "User site is compatible with broad commercial facility eligibility.",
            "Opportunity technology is available for retrofit discovery: energy_efficiency, hvac, lighting, battery_storage."
          ],
          "unresolvedRequirements": [],
          "blockers": [
      ...
      "v2PackageSummaries": [
        {
          "opportunityId": "SOURCE_DSIRE:dsire_program_id:1630",
          "programName": "Burbank Water & Power - Energy Solutions Business Rebate Program",
          "calculationStatus": "calculable_with_missing_inputs",
          "runtimeInclusionStatus": "not_user_facing_default",
          "includedInRuntimeTotals": false,
          "confidence": "medium",
          "missingInputs": [],
          "requiredInputs": [
            "bwp_business_account",
            "selected_measure",
            "eligible_units_tons_horsepower_linear_feet_kilolumens_or_annual_kwh_savings",
            "project_cost",
            "invoice_and_specification_documents",
          ...
          "defaultedInputs": [
            ...
            {
              "inputKey": "eligible_units_tons_horsepower_linear_feet_kilolumens_or_annual_kwh_savings",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            },
            {
              "inputKey": "invoice_and_specification_documents",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            },
            {
              "inputKey": "selected_catalog_row",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            },
          ...
          "effectSummaries": [
            {
              "effectId": "effect_one_time_savings_1_eac6533d65d35892",
              "effectType": "one_time_savings",
    ...
    },
    {
      ...
      "savingsPreview": {
        "status": "calculated",
        "unsupportedReason": null,
        "upfrontCostCents": 143000,
        "oneTimeSavingsCents": 0,
        "possibleGrantMoneyCents": 0,
        "annualRecurringSavingsCents": 28800,
        "annualRecurringExpensesCents": 0,
        "netAnnualRecurringSavingsCents": 28800,
        "incentiveCalculationPackageCounts": {
          "matchedPackageCount": 1,
          "runtimeRuleCount": 0,
          "includedPackageCount": 0,
      ...
      "scenarios": [
        {
          ...
          "firstYearNetRecurringSavingsCents": 0,
          "firstYearTotalBenefitCents": 0,
          "upfrontCostAfterSavingsCents": 143000,
          "upfrontSavingsEntries": [],
          "recurringSavingsEntries": [],
          "conflictExplanations": [],
          "capExplanations": [],
