  ...
  "retrofits": [
    {
      ...
      "matchedOpportunities": [
        ...
        },
        {
          ...
          "applicationUrl": "https://www.revenue.wi.gov/dorforms/pr-303.pdf",
          "matchedReasons": [
            "Opportunity appears rolling or no-deadline.",
            "Project site state WI matches opportunity geography.",
            "Utility provider is not applicable to this opportunity.",
            ...
            "Opportunity technology is available for retrofit discovery: solar, renewable_energy, wind, biomass_biogas, battery_storage."
          ],
          "unresolvedRequirements": [],
          "blockers": [
            "Battery storage is not independently listed on the official exemption request and should not be matched unless tied to a qualifying exempt system under current assessor guidance.",
            "Conventional energy equipment components are not exempt merely because they are present with a renewable system.",
            "This is a property tax exemption, not a rebate or grant."
          ],
          "hardRequirements": [
            "Property owner must file the Wisconsin Department of Revenue Energy System Exemption Request with supporting documentation.",
            "Request is due to the local assessor by March 1 for the applicable assessment year.",
            "Equipment must qualify under Wisconsin energy system exemption categories."
          ],
          "eligibleApplicantTypes": [
            "property_owner"
          ],
          ...
          "eligibleRetrofitCategories": [
            "biogas_energy_system",
            "synthetic_gas_energy_system",
            "solar_energy_system",
            "solar_thermal_water_heating",
            "solar_space_heating",
            "wind_energy_system"
          ],
          "evidenceText": "Wisconsin DOR exemption form lists biogas, synthetic gas, solar, and wind energy systems and asks owners to file the request with supporting documentation by March 1.",
          "reasoningNotes": "Preserve biogas and renewable-energy system categories. Remove unsupported battery storage because the official form does not list it as a stand-alone exempt category."
        },
        {
          ...
          "administrator": "Wisconsin PACE Commission / PACE Wisconsin",
          "state": "WI",
          "rankScore": 100,
          "matchConfidence": 1,
          "opportunityDataConfidence": 0.82,
          ...
          "unresolvedRequirements": [],
          "blockers": [
            "Standalone battery storage is not identified as eligible on current PACE Wisconsin owner or DNR pages.",
            "This is financing through a PACE assessment, not a rebate.",
            "Do not infer residential home weatherization or consumer appliance rebates."
          ],
          "hardRequirements": [
            "Property must be in a Wisconsin participating community.",
            "Owner must obtain financing through a qualified PACE lender.",
            "Wisconsin PACE Commission approval is required.",
            "Mortgage lender consent is required where applicable.",
            "Assessment term and amount must meet program rules."
          ],
          "eligibleApplicantTypes": [
          ...
          "evidenceText": "PACE]( Wisconsin says financing is available in participating communities for energy efficiency improvements, renewable energy systems and water conservation upgrades. Current owner and DNR pages do not identify standalone battery storage as an eligible measure.",
          "reasoningNotes": "The queued battery match is unsupported. Keep this as local-option PACE financing for efficiency, renewable energy, and water conservation only."
        },
        {
          ...
          "unresolvedRequirements": [],
          "blockers": [
            "Battery storage systems are not eligible under the solar product guidance.",
            "Solar hot-water storage tanks are excluded.",
            "Concrete foundations and nonqualifying wiring are excluded.",
            "General biomass equipment is not eligible unless it uses qualifying anaerobic-digestion gas.",
            "End-use appliances are not eligible merely because powered by renewable energy."
          ],
          "hardRequirements": [
            "Qualifying product must use wind energy, direct radiant energy from the sun or gas generated from anaerobic digestion of animal manure or other agricultural waste.",
            "Solar products must meet the applicable output threshold.",
            "Solar equipment must convert direct radiant energy into alternating-current electricity or heat.",
            "Required exemption documentation must be provided when applicable."
          ],
          "eligibleApplicantTypes": [
            "purchasers_of_qualifying_renewable_energy_products",
            "contractors_or_installers_as_consumers",
            "consumers"
          ],
          "eligibleSectors": [
            "residential",
          ...
          "eligibleRetrofitCategories": [
            ...
            "anaerobic_digestion_biogas_energy_system"
          ],
          "evidenceText": "Wisconsin Department of Revenue guidance exempts qualifying solar products such as PV equipment, solar thermal collectors, inverters and required installation hardware, while expressly excluding batteries, hot-water storage tanks and concrete foundations.",
          "reasoningNotes": "Removed battery storage and narrowed biomass to anaerobic-digestion biogas from agricultural waste. Preserved solar thermal only for the qualifying collector or heat-producing product, not storage tanks."
        }
      ],
      "v2PackageSummaries": []
    },
    ...
    },
    {
      ...
      "v2PackageSummaries": [
        {
          "opportunityId": "SOURCE_DSIRE:dsire_program_id:5218",
          "programName": "Commercial Retro-Commissioning and New Construction Program",
          ...
          "requiredInputs": [
            ...
            "verified_eui_reduction_percentage",
            "baseline_eui",
            ...
            "rsp_bonus_pass_through_status",
            "implementation_completion_date",
            "existing_building_age",
            "date_of_last_retro_commissioning_study",
            "participating_wisconsin_utility_service",
            "project_level_focus_incentive_total",
            "customer_calendar_year_focus_incentive_total",
            "total_audit_plus_implementation_cost",
            "project_level_and_customer_annual_incentive_totals",
            "project_path",
            "building_type",
            "design_stage_or_construction_stage",
            "participating_utility_service",
            "project_square_footage",
            "energy_model_or_online_analysis_inputs",
            "verified_savings",
            "design_stage_inputs"
          ],
          "defaultedInputs": [
            ...
            {
              "inputKey": "verified_eui_reduction_percentage",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            },
            ...
            {
              "inputKey": "annual_kwh_use",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            },
            {
              "inputKey": "annual_therm_use",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            },
            ...
            {
              "inputKey": "total_audit_cost",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            },
            {
              "inputKey": "total_implementation_cost",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            },
            {
              "inputKey": "rsp_bonus_pass_through_status",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            },
            {
              "inputKey": "implementation_completion_date",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            },
            {
              "inputKey": "existing_building_age",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            },
            {
              "inputKey": "date_of_last_retro_commissioning_study",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            },
            {
              "inputKey": "participating_wisconsin_utility_service",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            },
            {
              "inputKey": "project_level_focus_incentive_total",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            },
            {
              "inputKey": "customer_calendar_year_focus_incentive_total",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            },
            {
              "inputKey": "total_audit_plus_implementation_cost",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            },
            {
              "inputKey": "project_level_and_customer_annual_incentive_totals",
              "source": "synthetic_test_case_default",
              "defaultIsPlaceholder": true,
              "defaultConfidence": "low"
            },
          ...
          "effectSummaries": [
            {
              "effectId": "effect_one_time_savings_1_e310df5a62be2640",
            ...
            {
              "effectId": "effect_process_value_2_fd18aca817dd3472",
