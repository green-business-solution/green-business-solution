...
```json
{
  ...
  "siteEnergyProfile": {
    ...
    "latestUtilityProvider": "Kauai County refuse/recycling plus agricultural organics handling",
    "annualKwh": 3080000,
    "annualElectricCost": 1185800,
    "averageCostPerKwh": 0.385,
    "utilitySummaries": [
      {
  ...
  "siteTaxProfile": {
    "availableFieldIds": [
      ...
      "general_excise_gross_receipts_cents",
      "general_excise_tax_due_cents",
      "agricultural_equipment_use_tax_review_flag",
      "gas_service_status",
      "state_code"
    ]
  },
  "existingTaxFacts": [
    {
      "inputKey": "state_code",
      "value": "HI",
      "sourceFileId": "taxfile_046_kauai_coffee_kalaheo_01",
    ...
    },
    {
      ...
      "value": "taxable_agricultural_and_commercial_mixed_use",
      "sourceFileId": "taxfile_046_kauai_coffee_kalaheo_01",
      "sourceStrategy": "synthetic_tax_document",
      "uiPlacement": "property_tax_profile",
      "userOverrideAllowed": true,
    ...
    {
      "inputKey": "state_general_excise_tax_filer",
      "value": true,
      "sourceFileId": "taxfile_046_kauai_coffee_kalaheo_02",
      "sourceStrategy": "synthetic_tax_document",
    ...
    },
    {
      ...
      "sourceFileId": "taxfile_046_kauai_coffee_kalaheo_03",
      "sourceStrategy": "synthetic_tax_document",
      "uiPlacement": "organization_profile",
      "userOverrideAllowed": true,
      "defaultIsSynthetic": true,
  ...
  "existingTaxOpportunitySpecificInputs": [
    {
      ...
      "notes": "Suppress Michigan Renewable Energy Renaissance Zone treatment because the synthetic site state is HI, not Michigan, and no approved Michigan zone designation document is present."
    },
    {
      ...
      "estimateStatusIfUsed": "suppressed",
      "includeInUserFacingTotalBeforeConfirmation": false,
      "notes": "Suppress Rhode Island renewable property-tax valuation because the synthetic site is in HI, not Rhode Island."
    },
    {
      ...
      "estimateStatusIfUsed": "suppressed",
      "includeInUserFacingTotalBeforeConfirmation": false,
      "notes": "Suppress Washington solar-manufacturing B&O treatment because the synthetic site is in HI, not Washington, and the profile does not include a WA solar manufacturing B&O tax return."
    }
  ],
  "retrofitSummaries": [
    {
  ...
  "blockers": [
    {
      "value": "User site or facility type (agricultural_facility) does not match broad_residential eligibility.",
      "count": 553
    },
    {
      "value": "User site or facility type (agricultural_facility) does not match broad_commercial eligibility.",
      "count": 362
    },
    {
    ...
    {
      "value": "Opportunity site or facility specificity (multifamily_residential) does not match the user's site type (agricultural_facility).",
      "count": 65
    },
    {
    ...
    {
      "value": "Opportunity site or facility specificity (education_campus) does not match the user's site type (agricultural_facility).",
      "count": 38
    },
    {
      "value": "Project site state HI does not match opportunity geography VT.",
      "count": 37
    }
  ]
}
