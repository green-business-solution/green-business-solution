...
```json
{
  ...
  "normalizedProfile": {
    "site": {
      "addressStructured": {
        "raw": "2903 Sprankel Avenue, Memphis, TN 38118, USA",
        "stateCode": "TN",
        "zip5": "38118"
      },
      "geo": {
  ...
  "siteEnergyProfile": {
    ...
    "latestUtilityProvider": "Private commercial waste and recycling haulers",
    "annualKwh": 204800000,
    "annualElectricCost": 18488000,
    "averageCostPerKwh": 0.0903,
    "utilitySummaries": [
      {
  ...
  "siteTaxProfile": {
    "availableFieldIds": [
      ...
      "business_personal_property_tax_cents",
  ...
  "existingTaxFacts": [
    {
      "inputKey": "state_code",
      "value": "TN",
      "sourceFileId": "taxfile_fedex_memphis_2026_property_bill",
