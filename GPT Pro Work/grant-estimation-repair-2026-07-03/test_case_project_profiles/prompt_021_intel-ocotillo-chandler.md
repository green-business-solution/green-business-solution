...
```json
{
  ...
  "siteEnergyProfile": {
    ...
    "latestUtilityProvider": "Specialized industrial and commercial waste haulers",
    "annualKwh": 1707000000,
    "annualElectricCost": 110541000,
    "averageCostPerKwh": 0.0648,
    "utilitySummaries": [
      {
  ...
  "siteTaxProfile": {
    "availableFieldIds": [
      ...
      "manufacturing_equipment_use_tax_review_amount_cents",
  ...
  "existingTaxFacts": [
    {
      "inputKey": "state_code",
      "value": "AZ",
      "sourceFileId": "taxfile_intel_ocotillo_2026_property_bill",
    ...
    {
      "inputKey": "manufacturing_equipment_use_tax_review_amount_cents",
      "value": 189000000,
      "sourceFileId": "taxfile_intel_ocotillo_2026_tax_workpaper",
      "sourceStrategy": "synthetic_tax_document",
