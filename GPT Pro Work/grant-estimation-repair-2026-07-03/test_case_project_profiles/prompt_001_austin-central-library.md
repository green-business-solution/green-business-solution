...
```json
{
  ...
  "siteEnergyProfile": {
    ...
    "latestUtilityProvider": "City of Austin Resource Recovery / contracted commercial haulers",
    "annualKwh": 5775000,
    "annualElectricCost": 622650,
    "averageCostPerKwh": 0.1078,
    "utilitySummaries": [
      {
  ...
  "siteTaxProfile": {
    "availableFieldIds": [
      ...
      "local_sales_use_tax_exemption_status",
      "state_code"
    ]
  },
  "existingTaxFacts": [
    {
      "inputKey": "state_code",
      "value": "TX",
      "sourceFileId": "taxfile_041_austin_central_library_01",
    ...
    },
    {
      ...
      "value": true,
      "sourceFileId": "taxfile_041_austin_central_library_02",
      "sourceStrategy": "synthetic_tax_document",
  ...
  "existingTaxOpportunitySpecificInputs": [
    {
      ...
      "notes": "Suppress Michigan Renewable Energy Renaissance Zone treatment because the synthetic site state is TX, not Michigan, and no approved Michigan zone designation document is present."
    },
    {
      ...
      "estimateStatusIfUsed": "suppressed",
      "includeInUserFacingTotalBeforeConfirmation": false,
      "notes": "Suppress Rhode Island renewable property-tax valuation because the synthetic site is in TX, not Rhode Island."
    },
    {
      ...
      "estimateStatusIfUsed": "suppressed",
      "includeInUserFacingTotalBeforeConfirmation": false,
      "notes": "Suppress Washington solar-manufacturing B&O treatment because the synthetic site is in TX, not Washington, and the profile does not include a WA solar manufacturing B&O tax return."
    }
  ],
  "retrofitSummaries": [
    {
  ...
  "blockers": [
    ...
    {
      "value": "Project site state TX does not match opportunity geography CA.",
      "count": 176
    },
    {
      "value": "Project site state TX does not match opportunity geography MN.",
      "count": 112
    },
    {
    ...
    {
      "value": "Project site state TX does not match opportunity geography CO.",
      "count": 74
    },
    {
      "value": "Project site state TX does not match opportunity geography MA.",
      "count": 70
    },
    {
      "value": "Project site state TX does not match opportunity geography OR.",
      "count": 70
    },
    {
    ...
    {
      "value": "Project site state TX does not match opportunity geography WA.",
      "count": 61
    },
    {
      "value": "Project site state TX does not match opportunity geography FL.",
      "count": 55
    },
    {
      "value": "Project site state TX does not match opportunity geography MD.",
      "count": 53
    },
    {
      "value": "Project site state TX does not match opportunity geography IL.",
      "count": 47
    },
    {
      "value": "Project site state TX does not match opportunity geography IN.",
      "count": 46
    },
    {
      "value": "Project site state TX does not match opportunity geography PA.",
      "count": 46
    },
    {
      "value": "Project site state TX does not match opportunity geography NY.",
      "count": 43
    },
    {
      "value": "Project site state TX does not match opportunity geography NC.",
      "count": 40
    },
    {
    ...
    {
      "value": "Project site state TX does not match opportunity geography VT.",
      "count": 37
    }
  ]
}
