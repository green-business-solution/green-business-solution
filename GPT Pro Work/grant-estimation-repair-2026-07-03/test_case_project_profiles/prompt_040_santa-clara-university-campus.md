...
```json
{
  ...
  "siteEnergyProfile": {
    ...
    "latestUtilityProvider": "Mission Trail Waste Systems",
    "annualKwh": 38520000,
    "annualElectricCost": 5190200,
    "averageCostPerKwh": 0.1347,
    "utilitySummaries": [
      {
  ...
  "siteTaxProfile": {
    "availableFieldIds": [
      ...
      "education_welfare_exemption_value_cents",
      "nonexempt_taxable_value_cents",
      "annual_property_tax_due_cents",
      "possessory_interest_review_required",
      "campus_square_feet"
    ]
  },
  "existingTaxFacts": [
