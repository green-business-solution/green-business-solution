...
```json
{
  ...
  "normalizedProfile": {
    "site": {
      "addressStructured": {
        "raw": "5325 S Soto Street, Vernon, CA 90058, USA",
        "stateCode": "CA",
        "zip5": "90058"
      },
      "geo": {
  ...
  "siteEnergyProfile": {
    ...
    "latestUtilityProvider": "Vernon Public Utilities / contracted commercial hauler",
    "annualKwh": 12040000,
    "annualElectricCost": 1745800,
    "averageCostPerKwh": 0.145,
    "utilitySummaries": [
      {
  ...
  "siteTaxProfile": {
    "availableFieldIds": [
      ...
      "cold_storage_refrigeration_equipment_value_cents",
