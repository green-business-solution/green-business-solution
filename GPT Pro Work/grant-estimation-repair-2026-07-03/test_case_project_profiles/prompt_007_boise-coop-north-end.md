...
```json
{
  ...
  "siteEnergyProfile": {
    ...
    "annualKwh": 1000000,
    "annualElectricCost": 95000,
    "averageCostPerKwh": 0.095,
    "utilitySummaries": [
      {
  ...
  "siteTaxProfile": {
    "availableFieldIds": [
      ...
      "ownership_status_from_tax_bill",
  ...
  "blockers": [
    ...
    {
      "value": "Project site state ID does not match opportunity geography CA.",
      "count": 176
    },
    {
      "value": "Project site state ID does not match opportunity geography MN.",
      "count": 112
    },
    {
    ...
    {
      "value": "Project site state ID does not match opportunity geography CO.",
      "count": 74
    },
    {
      "value": "Project site state ID does not match opportunity geography MA.",
      "count": 70
    },
    {
      "value": "Project site state ID does not match opportunity geography OR.",
      "count": 70
    },
    {
      "value": "Project site state ID does not match opportunity geography TX.",
      "count": 67
    },
    {
    ...
    {
      "value": "Project site state ID does not match opportunity geography WA.",
      "count": 61
    },
    {
      "value": "Project site state ID does not match opportunity geography FL.",
      "count": 55
    },
    {
      "value": "Project site state ID does not match opportunity geography MD.",
      "count": 53
    },
    {
      "value": "Project site state ID does not match opportunity geography IL.",
      "count": 47
    },
    {
      "value": "Project site state ID does not match opportunity geography IN.",
      "count": 46
    },
    {
      "value": "Project site state ID does not match opportunity geography PA.",
      "count": 46
    },
    {
      "value": "Project site state ID does not match opportunity geography NY.",
      "count": 43
    },
    {
      "value": "Project site state ID does not match opportunity geography NC.",
      "count": 40
    },
    {
    ...
    {
      "value": "Project site state ID does not match opportunity geography VT.",
      "count": 37
    }
  ]
}
