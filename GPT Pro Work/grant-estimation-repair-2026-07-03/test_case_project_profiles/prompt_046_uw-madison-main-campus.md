...
```json
{
  ...
  "normalizedProfile": {
    "site": {
      "addressStructured": {
        "raw": "500 Lincoln Drive, Madison, WI 53706, USA",
        "stateCode": "WI",
        "zip5": "53706"
      },
      "geo": {
  ...
  "siteEnergyProfile": {
    ...
    "latestUtilityProvider": "UW-Madison campus waste and recycling services",
    "annualKwh": 332000000,
    "annualElectricCost": 33864000,
    "averageCostPerKwh": 0.102,
    "utilitySummaries": [
      {
  ...
  "siteTaxProfile": {
    "availableFieldIds": [
      ...
      "campus_aggregate_property_flag",
      ...
      "district_energy_tax_allocation_status",
      "state_code"
    ]
  },
  "existingTaxFacts": [
    {
      "inputKey": "state_code",
      "value": "WI",
      "sourceFileId": "taxfile_042_uw_madison_main_campus_01",
    ...
    },
    {
      ...
      "value": 17000000,
      "sourceFileId": "taxfile_042_uw_madison_main_campus_03",
      "sourceStrategy": "synthetic_tax_document",
    ...
    {
      "inputKey": "district_energy_tax_allocation_status",
      "value": "campus_level_allocation_review_required",
      "sourceFileId": "taxfile_042_uw_madison_main_campus_03",
      "sourceStrategy": "synthetic_tax_document",
