...
```json
{
  ...
  "siteEnergyProfile": {
    ...
    "latestUtilityProvider": "Recology Sonoma Marin",
    "annualKwh": 1920000,
    "annualElectricCost": 326400,
  ...
  "siteTaxProfile": {
    "availableFieldIds": [
      ...
      "winery_process_equipment_assessed_value_cents",
      "agricultural_assessment_review_required",
