...
| ITC-02/requirement-new-fixture-watts | DOCUMENTATION_ONLY | scripts/research/operational-savings/adapters/femp-lighting/run.mjs | femp-exterior-lighting-checksum-mutation-proof: PASSED; scripts/research/operational-savings/tests/femp-lighting-real.test.mjs :: fails a corrupt artifact checksum<br>femp-exterior-lighting-offline-proof: PASSED; scripts/research/operational-savings/tests/femp-lighting-real.test.mjs :: requires offline mode and makes no runtime network call<br>femp-exterior-lighting-requirement-mapping-proof: PASSED; scripts/research/operational-savings/tests/femp-lighting-real.test.mjs :: maps an exact application and supplied lumen requirement to the ITC-02 power ceiling<br>femp-exterior-lighting-resolution-failure-proof: PASSED; scripts/research/operational-savings/tests/femp-lighting-real.test.mjs :: fails closed on unknown applications and invalid required light output<br>femp-exterior-lighting-schema-mutation-proof: PASSED; scripts/research/operational-savings/tests/femp-lighting-real.test.mjs :: fails header, threshold-unit, and duplicate-application schema mutations<br>femp-exterior-lighting-schema-publication-proof: PASSED; scripts/research/operational-savings/tests/femp-lighting-real.test.mjs :: parses and publishes the exact seven-row FEMP Table 1 with its pinned checksum | EXECUTION_RUN_RECORD_REQUIRED: The static proof declaration is not counted as executed proof until one current local content-bound run record covers every required exact test. | Acquire or implement the missing evidence named by the blocker, then add exact adapter tests before claiming executable coverage. EXECUTION_RUN_RECORD_REQUIRED: The static proof declaration is not counted as executed proof until one current local content-bound run record covers every required exact test. |
| ITC-02/lighting-replacement-calculation | DOCUMENTATION_ONLY | scripts/research/operational-savings/adapters/femp-lighting/run.mjs | femp-exterior-lighting-resolution-failure-proof: PASSED; scripts/research/operational-savings/tests/femp-lighting-real.test.mjs :: fails closed on unknown applications and invalid required light output<br>itc02-lighting-composition-real-proof: PASSED; scripts/research/operational-savings/tests/femp-lighting-real.test.mjs :: composes real benchmark, requirement, and schedule outputs into annual_kWh | EXECUTION_RUN_RECORD_REQUIRED: The static proof declaration is not counted as executed proof until one current local content-bound run record covers every required exact test. | Acquire or implement the missing evidence named by the blocker, then add exact adapter tests before claiming executable coverage. EXECUTION_RUN_RECORD_REQUIRED: The static proof declaration is not counted as executed proof until one current local content-bound run record covers every required exact test. |
