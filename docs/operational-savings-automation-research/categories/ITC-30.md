...
| context_benchmarks | END_TO_END_REAL | scripts/research/operational-savings/adapters/context-benchmarks/run.mjs | context-argonne-forklift-real-proof: PASSED; scripts/research/operational-savings/tests/context-argonne-forklift-real.test.mjs :: maps both exact ITC-30 hourly intensity terms<br>context-argonne-scope-failure-proof: PASSED; scripts/research/operational-savings/tests/context-argonne-forklift-real.test.mjs :: fails closed for every incompatible class or duty dimension | None |
