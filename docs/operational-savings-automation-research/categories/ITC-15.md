...
The category contains 0 category-local process instances and references 0 canonical Standards.
...
The category depends on these source-level verdicts: no external Standard.
