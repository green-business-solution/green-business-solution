...
| reopt_local_dispatch | END_TO_END_REAL | scripts/research/operational-savings/adapters/reopt/run.mjs | reopt-offline-proof: PASSED; scripts/research/operational-savings/tests/reopt-source-real.test.mjs :: requires offline mode and never calls fetch<br>reopt-real-source-schema-proof: PASSED; scripts/research/operational-savings/tests/reopt-source-real.test.mjs :: publishes exact offline official, baseline, and proposed runs<br>reopt-source-schema-failure-proof: PASSED; scripts/research/operational-savings/tests/reopt-source-real.test.mjs :: fails missing structs, missing result keys, and changed package identity | None |
