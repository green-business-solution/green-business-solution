...
**Purpose:**
Use U.S. Department of Energy - MEASUR to resolve existing pump input power; Proposed pump input power from the listed category inputs.
...
* Existing pump input power
* Proposed pump input power
...
4. Return one selected existing pump input power; Proposed pump input power.
