...
- **What this category means:** Evaluate operational savings for Efficient pump replacement.
- **What the formula calculates:** input kW difference -> annual kWh -> rate.
- **What RetroFi asks during ordinary screening:** Count of identical units in project scope; Required flow; Total dynamic head; and 5 more staged screening input(s).
...
- **What remains unsupported:** Exact MEASUR pump adapter and schedule fixture.
- **Why the status is Draft:** Exact MEASUR pump adapter and schedule fixture.
- **Decision requested:** Decide whether RetroFi should keep Pump wire-to-water replacement at no estimate until this category-specific gate is resolved: Exact MEASUR pump adapter and schedule fixture.
...
- **Limitation:** Exact MEASUR pump adapter and schedule fixture.
...
### Term: `hydraulic_power_kW`

- **Unit:** kW (`kw`)
- **Dimension:** power
- **Quantity kind:** power
- **Formula role:** Calculates wire-to-water input power with each efficiency applied once
- **Resolved by:** Exact pump inputs and MEASUR adapter
- **Exact path:** evidence:E-MEASUR-ITC40
- **Fallback:** None
- **Evidence:** E-MEASUR-ITC40 - UNVERIFIED
- **Source location:** ITC-40 pump adapter not selected: Calculator ID, inputs, units, output, function, and golden example missing
- **Missing behavior:** NO_ESTIMATE

### Term: `pump_efficiency`
...
- `operating_schedule_details` - **Optional:** Detailed operating days, shifts, or active season when known.
  - **Resolved by:**
    - **User:** Annual dollar savings > Annual pump electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Detailed Operating Days, Shifts, or Active Season, if known
...
- Decide whether RetroFi should keep Pump wire-to-water replacement at no estimate until this category-specific gate is resolved: Exact MEASUR pump adapter and schedule fixture.
