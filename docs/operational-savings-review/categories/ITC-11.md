...
|---|---|---|---|---|---|---|---|
| annual_affected_refrigeration_kWh | kWh/year | Measurement or user-confirmed bill allocation | utilityExtractedValues[].fieldId=annual_kwh plus User refrigeration share | None | Direct input or formula | Affected refrigeration annual kWh | NO_ESTIMATE |
| baseline_annual_kWh | kWh/year, kWh/year, fraction | STD-SCOUT-ECM-SCREEN | evidence:E-SCOUT-ECM | None | E-SCOUT-ECM: UNVERIFIED | ECM definitions and Scout processing code - Exact ECM identifier, market segment, performance field, and processing function not yet pinned | NO_ESTIMATE |
| proposed_annual_kWh | kWh/year, kWh/year, fraction | STD-SCOUT-ECM-SCREEN | evidence:E-SCOUT-ECM | None | E-SCOUT-ECM: UNVERIFIED | ECM definitions and Scout processing code - Exact ECM identifier, market segment, performance field, and processing function not yet pinned | NO_ESTIMATE |
| reduction_fraction | kWh/year, kWh/year, fraction | STD-SCOUT-ECM-SCREEN | evidence:E-SCOUT-ECM | None | E-SCOUT-ECM: UNVERIFIED | ECM definitions and Scout processing code - Exact ECM identifier, market segment, performance field, and processing function not yet pinned | NO_ESTIMATE |
