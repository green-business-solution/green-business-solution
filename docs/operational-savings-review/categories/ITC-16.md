...
|---|---|---|---|---|---|---|---|
| baseline_load_t | kW or kWh/interval | Required uploaded interval artifact | User Green Button interval artifact | None | Direct input or formula | Chronological load and tariff | NO_ESTIMATE |
| shed_t | kW or kWh/interval | User event constraints and formula | User shed and rebound profile | None | Direct input or formula | Maximum shed kW, if known (User)<br>Rebound or recovery constraint, if known (User) | NO_ESTIMATE |
| rebound_t | kW or kWh/interval | User event constraints and formula | User shed and rebound profile | None | Direct input or formula | Maximum shed kW, if known (User)<br>Rebound or recovery constraint, if known (User) | NO_ESTIMATE |
| proposed_load_t | kW or kWh/interval | User event constraints and formula | User shed and rebound profile | None | Direct input or formula | Maximum shed kW, if known (User)<br>Rebound or recovery constraint, if known (User) | NO_ESTIMATE |
