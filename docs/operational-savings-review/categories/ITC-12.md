...
**Purpose:**
Use U.S. Department of Energy - MEASUR to resolve existing motor input power; Proposed motor input power from the listed category inputs.
...
* Existing motor input power
* Proposed motor input power
...
4. Return one selected existing motor input power; Proposed motor input power.
