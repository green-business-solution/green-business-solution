...
- **What this category means:** Evaluate operational savings for Refrigeration EC motor retrofit.
- **What the formula calculates:** input kW difference -> kWh -> electric rate.
- **What RetroFi asks during ordinary screening:** Count of identical units in project scope; Existing motor input or shaft rating; Proposed motor input or shaft rating; and 1 more staged screening input(s).
...
- **Decision requested:** Decide whether RetroFi should keep Refrigeration EC-motor power reduction at no estimate until this category-specific gate is resolved: Exact MEASUR motor adapter and schedule fixture.
...
- **Dimension:** count
- **Quantity kind:** count
- **Formula role:** Scopes motor count
- **Resolved by:** User
...
- **Dimension:** power
- **Quantity kind:** power
- **Formula role:** Resolves existing and proposed input power once
- **Resolved by:** Exact MEASUR adapter or measured input
- **Exact path:** evidence:E-MEASUR-ITC12
- **Fallback:** None
- **Evidence:** E-MEASUR-ITC12 - UNVERIFIED
- **Source location:** ITC-12 motor adapter not selected: Calculator ID, inputs, units, output, function, and golden example missing
- **Missing behavior:** NO_ESTIMATE
...
- **Formula role:** Annualizes power difference
- **Resolved by:** Explicit schedule
- **Exact path:** schedule.explicit_calendar_hours
- **Fallback:** None
...
- **Minimum required inputs:** quantity; shaft or input power; existing and proposed efficiency; schedule.
- **Exact scenario:** insufficient-data.
- **Source fixture:** None.
- **Low/base/high calculation:** Explicit sensitivities only.
- **Final result path:** input kW difference -> kWh -> electric rate
- **Uncertainty:** High.
...
- Annual electricity reduction > Existing motor input or shaft rating
- Annual electricity reduction > Proposed motor input or shaft rating
- Annual electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Recognizable Business, Shift, Seasonal, or Usage Pattern
...
- Annual electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Detailed Operating Days, Shifts, or Active Season, if known
- Annual electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Measured Annual Operating Hours, if known
...
- Annual electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > site.geo.coordinates and business.primaryActivityText
...
- `measur_calculator_inputs` - **Required:** Every calculator-specific equipment, operating-point, schedule, and resource input shown as an atomic leaf in the applicable category tree; the category contract deterministically selects the calculator ID.
  - **Resolved by:**
    ...
    - **User:** Annual dollar savings > Annual electricity reduction > Existing motor input or shaft rating
    - **User:** Annual dollar savings > Annual electricity reduction > Proposed motor input or shaft rating
    - **User:** Annual dollar savings > Annual electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Measured Annual Operating Hours, if known
...
- `operating_schedule` - **Required:** Recognizable usage or control pattern and available Profile context.
  - **Resolved by:**
    - **User:** Annual dollar savings > Annual electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Recognizable Business, Shift, Seasonal, or Usage Pattern
    - **User:** Annual dollar savings > Annual electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Measured Annual Operating Hours, if known
    - **Profile:** Annual dollar savings > Annual electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > site.geo.coordinates and business.primaryActivityText
    - **Standard:** Annual dollar savings > Annual electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Deterministic annual operating-hours resolution
- `operating_schedule_details` - **Optional:** Detailed operating days, shifts, or active season when known.
  - **Resolved by:**
    - **User:** Annual dollar savings > Annual electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Detailed Operating Days, Shifts, or Active Season, if known
...
Fan duty must be unchanged; a changed fan operating profile belongs in ITC-39 or ITC-41.
...
- Decide whether RetroFi should keep Refrigeration EC-motor power reduction at no estimate until this category-specific gate is resolved: Exact MEASUR motor adapter and schedule fixture.
