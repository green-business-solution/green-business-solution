...
|---|---|---|---|---|---|---|---|
| existing_distribution_heat | kWh-thermal/year and resource-unit/year | Exact project heat-loss inputs and MEASUR adapter plus formula | User existing and proposed annual distribution heat loss<br>evidence:E-MEASUR-ITC09 | None | E-MEASUR-ITC09: UNVERIFIED | ITC-09 recirculation adapter not selected - Calculator ID, inputs, units, output, function, and golden example missing | NO_ESTIMATE |
| proposed_distribution_heat | kWh-thermal/year and resource-unit/year | Exact project heat-loss inputs and MEASUR adapter plus formula | User existing and proposed annual distribution heat loss<br>evidence:E-MEASUR-ITC09 | None | E-MEASUR-ITC09: UNVERIFIED | ITC-09 recirculation adapter not selected - Calculator ID, inputs, units, output, function, and golden example missing | NO_ESTIMATE |
| avoided_distribution_heat | kWh-thermal/year and resource-unit/year | Exact project heat-loss inputs and MEASUR adapter plus formula | User existing and proposed annual distribution heat loss<br>evidence:E-MEASUR-ITC09 | None | E-MEASUR-ITC09: UNVERIFIED | ITC-09 recirculation adapter not selected - Calculator ID, inputs, units, output, function, and golden example missing | NO_ESTIMATE |
| avoided_thermal_input | kWh-thermal/year and resource-unit/year | Exact project heat-loss inputs and MEASUR adapter plus formula | User existing and proposed annual distribution heat loss<br>evidence:E-MEASUR-ITC09 | None | E-MEASUR-ITC09: UNVERIFIED | ITC-09 recirculation adapter not selected - Calculator ID, inputs, units, output, function, and golden example missing | NO_ESTIMATE |
| heater_efficiency | fraction | Exact project input | User heater efficiency | None | Direct input or formula | Existing water-heating system efficiency, if known (User) | NO_ESTIMATE |
| pump_kW | kW, hours/year, kWh/year | Exact pump input and explicit schedule | User pump kW<br>schedule.explicit_calendar_hours | None | E-SCHEDULE-EXPLICIT: UNVERIFIED | Calendar arithmetic and USNO daylight definitions - annual hours from explicit hours/day, days/week, active weeks, holidays, timezone, and declared daylight control | OMIT_PUMP_COMPONENT_OR_NO_ESTIMATE |
| avoided_run_hours | kW, hours/year, kWh/year | Exact pump input and explicit schedule | User pump kW<br>schedule.explicit_calendar_hours | None | E-SCHEDULE-EXPLICIT: UNVERIFIED | Calendar arithmetic and USNO daylight definitions - annual hours from explicit hours/day, days/week, active weeks, holidays, timezone, and declared daylight control | OMIT_PUMP_COMPONENT_OR_NO_ESTIMATE |
| avoided_pump_kWh | kW, hours/year, kWh/year | Exact pump input and explicit schedule | User pump kW<br>schedule.explicit_calendar_hours | None | E-SCHEDULE-EXPLICIT: UNVERIFIED | Calendar arithmetic and USNO daylight definitions - annual hours from explicit hours/day, days/week, active weeks, holidays, timezone, and declared daylight control | OMIT_PUMP_COMPONENT_OR_NO_ESTIMATE |
