...
- **What this category means:** Evaluate operational savings for Water-heating controls / recirculation controls.
- **What the formula calculates:** avoided heat and pump kWh -> matched rates.
- **What RetroFi asks during ordinary screening:** Existing annual distribution heat loss; Proposed annual distribution heat loss; Existing water-heating system efficiency; and 4 more staged screening input(s).
...
- **What remains unsupported:** Exact MEASUR heat-loss adapter, physical-input boundary, and schedule fixture.
- **Why the status is Draft:** Exact MEASUR heat-loss adapter, physical-input boundary, and schedule fixture.
- **Decision requested:** Decide whether RetroFi should keep Water-heating recirculation loss reduction at no estimate until this category-specific gate is resolved: Exact MEASUR heat-loss adapter, physical-input boundary, and schedule fixture.
...
- **Limitation:** Exact MEASUR heat-loss adapter, physical-input boundary, and schedule fixture.
...
### Term: `existing_distribution_heat`

- **Unit:** energy/year (`energy_year`)
- **Dimension:** energy_per_time
- **Quantity kind:** energy
- **Formula role:** Calculates avoided distribution heat and purchased thermal-input reduction
- **Resolved by:** Exact project heat-loss inputs and MEASUR adapter plus formula
- **Exact path:** User existing and proposed annual distribution heat loss; evidence:E-MEASUR-ITC09
- **Fallback:** None
- **Evidence:** E-MEASUR-ITC09 - UNVERIFIED
- **Source location:** ITC-09 recirculation adapter not selected: Calculator ID, inputs, units, output, function, and golden example missing
- **Missing behavior:** NO_ESTIMATE

### Term: `proposed_distribution_heat`
...
### Term: `avoided_distribution_heat`
...
- **Quantity kind:** ratio
- **Formula role:** Converts avoided heat to purchased input
- **Resolved by:** Exact project input
- **Exact path:** User heater efficiency
- **Fallback:** None
- **Evidence:** Direct input or deterministic formula
- **Source location:** Existing water-heating system efficiency, if known (User)
- **Missing behavior:** NO_ESTIMATE
...
- **Dimension:** power
- **Quantity kind:** power
- **Formula role:** Calculates avoided pump energy
- **Resolved by:** Exact pump input and explicit schedule
- **Exact path:** User pump kW; schedule.explicit_calendar_hours
- **Fallback:** None
...
- **Missing behavior:** OMIT_PUMP_COMPONENT_OR_NO_ESTIMATE

### Term: `avoided_run_hours`
...
- **Dimension:** energy
- **Quantity kind:** energy
- **Formula role:** Executes to_billed_unit exactly once before pricing avoided thermal input
...
- **Quantity kind:** price
- **Formula role:** Values thermal and pump savings
- **Resolved by:** Bill
...
- **Minimum required inputs:** existing and proposed annual distribution heat loss; heater efficiency; pump input; operating schedule.
- **Exact scenario:** insufficient-data.
- **Source fixture:** None.
- **Low/base/high calculation:** Explicit sensitivities only.
- **Final result path:** avoided heat and pump kWh -> matched rates
- **Uncertainty:** High.
- **Executable golden fixture:** No.
- **Remaining gate:** Exact MEASUR heat-loss adapter, physical-input boundary, and schedule fixture.
- **Golden result:** None
...
│  ├─ Existing water-heating system efficiency (User)
...
- Annual thermal-input and pump-electricity reduction > Existing annual distribution heat loss
- Annual thermal-input and pump-electricity reduction > Proposed annual distribution heat loss
- Annual thermal-input and pump-electricity reduction > Existing water-heating system efficiency
...
- Annual thermal-input and pump-electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Recognizable Business, Shift, Seasonal, or Usage Pattern
...
- Annual thermal-input and pump-electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Detailed Operating Days, Shifts, or Active Season, if known
- Annual thermal-input and pump-electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Measured Annual Operating Hours, if known
...
- Annual thermal-input and pump-electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > site.geo.coordinates and business.primaryActivityText
...
- `measur_calculator_inputs` - **Required:** Every calculator-specific equipment, operating-point, schedule, and resource input shown as an atomic leaf in the applicable category tree; the category contract deterministically selects the calculator ID.
  - **Resolved by:**
    - **User:** Annual dollar savings > Annual thermal-input and pump-electricity reduction > Existing annual distribution heat loss
    - **User:** Annual dollar savings > Annual thermal-input and pump-electricity reduction > Proposed annual distribution heat loss
    - **User:** Annual dollar savings > Annual thermal-input and pump-electricity reduction > Existing water-heating system efficiency
    ...
    - **User:** Annual dollar savings > Annual thermal-input and pump-electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Measured Annual Operating Hours, if known
...
- `operating_schedule` - **Required:** Recognizable usage or control pattern and available Profile context.
  - **Resolved by:**
    - **User:** Annual dollar savings > Annual thermal-input and pump-electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Recognizable Business, Shift, Seasonal, or Usage Pattern
    - **User:** Annual dollar savings > Annual thermal-input and pump-electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Measured Annual Operating Hours, if known
    - **Profile:** Annual dollar savings > Annual thermal-input and pump-electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > site.geo.coordinates and business.primaryActivityText
    - **Standard:** Annual dollar savings > Annual thermal-input and pump-electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Deterministic annual operating-hours resolution
- `operating_schedule_details` - **Optional:** Detailed operating days, shifts, or active season when known.
  - **Resolved by:**
    - **User:** Annual dollar savings > Annual thermal-input and pump-electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Detailed Operating Days, Shifts, or Active Season, if known
...
Status remains DRAFT until the adapter pins its heat-loss boundary, required physical inputs, and a golden example.
...
- Decide whether RetroFi should keep Water-heating recirculation loss reduction at no estimate until this category-specific gate is resolved: Exact MEASUR heat-loss adapter, physical-input boundary, and schedule fixture.
