...
│  ├─ Recirculation share of water-heating resource, if known (User)
│  ├─ Existing control schedule (User)
│  ├─ Proposed control schedule (User)
│  ├─ Pump input kW, if known (User)
...
- Annual thermal-input and pump-electricity reduction > Recirculation share of water-heating resource, if known
- Annual thermal-input and pump-electricity reduction > Pump input kW, if known
...
- Annual thermal-input and pump-electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > site.geo coordinates and business schedule context

### Bill Inputs

- Annual thermal-input and pump-electricity reduction > Annual billed resource r [BR-ANNUAL-BILL-RESOURCE] > annual_kwh for electricity
- Annual thermal-input and pump-electricity reduction > Annual billed resource r [BR-ANNUAL-BILL-RESOURCE] > annual_therms for gas
...
- `measur_calculator_inputs` - **Required:** Every calculator-specific equipment, operating-point, schedule, and resource input shown as an atomic leaf in the applicable category tree; the category contract deterministically selects the calculator ID.
  - **Resolved by:**
    - **User:** Annual dollar savings > Annual thermal-input and pump-electricity reduction > Recirculation share of water-heating resource, if known
    ...
    - **User:** Annual dollar savings > Annual thermal-input and pump-electricity reduction > Pump input kW, if known
...
- `operating_schedule` - **Required:** Recognizable usage or control pattern and available Profile context.
  - **Resolved by:**
    ...
    - **User:** Annual dollar savings > Annual thermal-input and pump-electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Measured Annual Operating Hours, if known
    - **Profile:** Annual dollar savings > Annual thermal-input and pump-electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > site.geo coordinates and business schedule context
