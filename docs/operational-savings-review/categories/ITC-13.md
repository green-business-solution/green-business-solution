...
│  ├─ Annual pounds of ice produced per machine, if known (User)
...
- Annual ice-machine electricity and water reduction > Annual pounds of ice produced per machine, if known

Optional Known Details replace the corresponding Standard estimate when supplied and validated.

### Profile Inputs

- Annual ice-machine electricity and water reduction > Certified existing and proposed product resolution [BR-CERTIFIED-PRODUCT-RESOLUTION] > Linked Opportunity
...
- `linked_opportunity` - **Conditional:** Product, certification, class, or minimum-performance restriction when a Linked Opportunity supplies one. Applies only in the documented scenario.
  - **Resolved by:**
    - **Profile:** Annual dollar savings > Annual ice-machine electricity and water reduction > Certified existing and proposed product resolution [BR-CERTIFIED-PRODUCT-RESOLUTION] > Linked Opportunity
