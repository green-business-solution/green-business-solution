...
|---|---|---|---|---|---|---|---|
| quantity | traps, mass/hour, hours/year, mass/year | Measured inputs and explicit schedule | User inputs<br>schedule.explicit_calendar_hours<br>evidence:E-MEASUR-ITC47 | None | E-MEASUR-ITC47: UNVERIFIED<br>E-SCHEDULE-EXPLICIT: UNVERIFIED | ITC-47 steam-trap adapter not selected - Calculator ID, inputs, units, output, function, and golden example missing<br>Calendar arithmetic and USNO daylight definitions - annual hours from explicit hours/day, days/week, active weeks, holidays, timezone, and declared daylight control | NO_ESTIMATE |
| steam_loss_rate | traps, mass/hour, hours/year, mass/year | Measured inputs and explicit schedule | User inputs<br>schedule.explicit_calendar_hours<br>evidence:E-MEASUR-ITC47 | None | E-MEASUR-ITC47: UNVERIFIED<br>E-SCHEDULE-EXPLICIT: UNVERIFIED | ITC-47 steam-trap adapter not selected - Calculator ID, inputs, units, output, function, and golden example missing<br>Calendar arithmetic and USNO daylight definitions - annual hours from explicit hours/day, days/week, active weeks, holidays, timezone, and declared daylight control | NO_ESTIMATE |
| annual_pressurized_hours | traps, mass/hour, hours/year, mass/year | Measured inputs and explicit schedule | User inputs<br>schedule.explicit_calendar_hours<br>evidence:E-MEASUR-ITC47 | None | E-MEASUR-ITC47: UNVERIFIED<br>E-SCHEDULE-EXPLICIT: UNVERIFIED | ITC-47 steam-trap adapter not selected - Calculator ID, inputs, units, output, function, and golden example missing<br>Calendar arithmetic and USNO daylight definitions - annual hours from explicit hours/day, days/week, active weeks, holidays, timezone, and declared daylight control | NO_ESTIMATE |
| avoided_steam_loss | traps, mass/hour, hours/year, mass/year | Measured inputs and explicit schedule | User inputs<br>schedule.explicit_calendar_hours<br>evidence:E-MEASUR-ITC47 | None | E-MEASUR-ITC47: UNVERIFIED<br>E-SCHEDULE-EXPLICIT: UNVERIFIED | ITC-47 steam-trap adapter not selected - Calculator ID, inputs, units, output, function, and golden example missing<br>Calendar arithmetic and USNO daylight definitions - annual hours from explicit hours/day, days/week, active weeks, holidays, timezone, and declared daylight control | NO_ESTIMATE |
| steam_enthalpy_rise | energy/mass, fraction, fuel-unit/mass | Exact steam conditions and boiler input | User steam pressure, feedwater condition, and boiler efficiency | None | E-MEASUR-ITC47: UNVERIFIED | ITC-47 steam-trap adapter not selected - Calculator ID, inputs, units, output, function, and golden example missing | NO_ESTIMATE |
| boiler_efficiency | energy/mass, fraction, fuel-unit/mass | Exact steam conditions and boiler input | User steam pressure, feedwater condition, and boiler efficiency | None | E-MEASUR-ITC47: UNVERIFIED | ITC-47 steam-trap adapter not selected - Calculator ID, inputs, units, output, function, and golden example missing | NO_ESTIMATE |
| boiler_fuel_per_steam_unit | energy/mass, fraction, fuel-unit/mass | Exact steam conditions and boiler input | User steam pressure, feedwater condition, and boiler efficiency | None | E-MEASUR-ITC47: UNVERIFIED | ITC-47 steam-trap adapter not selected - Calculator ID, inputs, units, output, function, and golden example missing | NO_ESTIMATE |
...
| p_fuel | USD/fuel-unit | Bill or documented project fuel price | gas-volumetric: utilityExtractedValues[].fieldId=average_cost_per_therm<br>gas-volumetric: utilityExtractedValues[].fieldId=gas_delivery_charges<br>gas-volumetric: utilityExtractedValues[].fieldId=gas_procurement_charges<br>fuel-price: Required documented project fuel-price input | None | Direct input or formula | Gas volumetric charge | RETURN_FUEL_WITHOUT_DOLLAR_VALUE |
