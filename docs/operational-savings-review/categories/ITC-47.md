...
**Purpose:**
Use U.S. Department of Energy reference buildings and U.S. Naval Observatory daylight data to resolve annual pressurized hours from the listed category inputs.
...
4. Return one selected annual pressurized hours.
...
**Purpose:**
Use U.S. Department of Energy - MEASUR to resolve annual avoided steam loss per equipment unit from the listed category inputs.
...
* Annual avoided steam loss per equipment unit
...
4. Return one selected annual avoided steam loss per equipment unit.
