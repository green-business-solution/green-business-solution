...
- **What this category means:** Evaluate operational savings for Steam trap replacement.
- **What the formula calculates:** steam loss -> boiler fuel -> rate.
- **What RetroFi asks during ordinary screening:** Count of identical units in project scope; Failed-trap condition; Leak class; and 4 more staged screening input(s).
- **What RetroFi resolves automatically:** 1 Profile value(s), 1 Bill value(s), 2 Standard result(s).
- **Conditional Calculation Gates:** None.
- **What remains unsupported:** Exact MEASUR steam adapter and golden fixture.
- **Why the status is Draft:** Exact MEASUR steam adapter and golden fixture.
- **Decision requested:** Decide whether RetroFi should keep Steam-trap loss reduction at no estimate until this category-specific gate is resolved: Exact MEASUR steam adapter and golden fixture.
...
- **Limitation:** Exact MEASUR steam adapter and golden fixture.
...
- **Dimension:** count
- **Quantity kind:** count
- **Formula role:** Calculates annual steam loss once
- **Resolved by:** Measured inputs and explicit schedule
- **Exact path:** User inputs; schedule.explicit_calendar_hours; evidence:E-MEASUR-ITC47
- **Fallback:** None
- **Evidence:** E-MEASUR-ITC47 - UNVERIFIED; E-SCHEDULE-EXPLICIT - UNVERIFIED
- **Source location:** ITC-47 steam-trap adapter not selected: Calculator ID, inputs, units, output, function, and golden example missing; Calendar arithmetic and USNO daylight definitions: annual hours from explicit hours/day, days/week, active weeks, holidays, timezone, and declared daylight control
- **Missing behavior:** NO_ESTIMATE

### Term: `steam_loss_rate`

- **Unit:** mass/hour (`mass_hour`)
- **Dimension:** mass_per_time
- **Quantity kind:** mass
- **Formula role:** Calculates annual steam loss once
- **Resolved by:** Measured inputs and explicit schedule
- **Exact path:** User inputs; schedule.explicit_calendar_hours; evidence:E-MEASUR-ITC47
...
### Term: `avoided_steam_loss`

- **Unit:** mass/year (`mass_year`)
- **Dimension:** mass_per_time
- **Quantity kind:** mass
- **Formula role:** Calculates annual steam loss once
- **Resolved by:** Measured inputs and explicit schedule
...
### Term: `steam_enthalpy_rise`

- **Unit:** energy/mass (`energy_mass`)
- **Dimension:** energy
- **Quantity kind:** energy
- **Formula role:** Converts lost steam to boiler fuel once
- **Resolved by:** Exact steam conditions and boiler input
- **Exact path:** User steam pressure, feedwater condition, and boiler efficiency
- **Fallback:** None
- **Evidence:** E-MEASUR-ITC47 - UNVERIFIED
- **Source location:** ITC-47 steam-trap adapter not selected: Calculator ID, inputs, units, output, function, and golden example missing
- **Missing behavior:** NO_ESTIMATE

### Term: `boiler_efficiency`
...
### Term: `boiler_fuel_per_steam_unit`

- **Unit:** fuel-unit/mass (`fuel_unit_mass`)
- **Dimension:** mass
- **Quantity kind:** mass
- **Formula role:** Converts lost steam to boiler fuel once
- **Resolved by:** Exact steam conditions and boiler input
...
- **Dimension:** energy
- **Quantity kind:** energy
- **Formula role:** Executes to_billed_unit exactly once for boiler fuel per steam unit
...
- **Unit:** USD/fuel-unit (`usd_fuel_unit`)
- **Dimension:** currency_per_resource
- **Quantity kind:** price
- **Formula role:** Values avoided fuel
- **Resolved by:** Bill or documented project fuel price
- **Exact path:** gas-volumetric: utilityExtractedValues[].fieldId=average_cost_per_therm; gas-volumetric: utilityExtractedValues[].fieldId=gas_delivery_charges; gas-volumetric: utilityExtractedValues[].fieldId=gas_procurement_charges; fuel-price: Required documented project fuel-price input
- **Fallback:** None
- **Evidence:** Direct input or deterministic formula
- **Source location:** Gas volumetric charge
- **Missing behavior:** RETURN_FUEL_WITHOUT_DOLLAR_VALUE
...
- **Minimum required inputs:** quantity; steam loss rate; steam conditions; pressurized hours; boiler efficiency.
- **Exact scenario:** insufficient-data.
- **Source fixture:** None.
- **Low/base/high calculation:** Explicit measurement sensitivities only.
- **Final result path:** steam loss -> boiler fuel -> rate
- **Uncertainty:** High.
- **Executable golden fixture:** No.
- **Remaining gate:** Exact MEASUR steam adapter and golden fixture.
- **Golden result:** None
...
- Annual steam-trap fuel reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > site.geo.coordinates and business.primaryActivityText
...
- `operating_schedule` - **Required:** Recognizable usage or control pattern and available Profile context.
  - **Resolved by:**
    ...
    - **User:** Annual dollar savings > Annual steam-trap fuel reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Measured Annual Operating Hours, if known
    - **Profile:** Annual dollar savings > Annual steam-trap fuel reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > site.geo.coordinates and business.primaryActivityText
...
- Decide whether RetroFi should keep Steam-trap loss reduction at no estimate until this category-specific gate is resolved: Exact MEASUR steam adapter and golden fixture.
