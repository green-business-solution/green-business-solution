...
│  ├─ Leak class (User)
│  ├─ Documented Steam Pressure from Nameplate, Measurement, Audit, or Contractor Specification (Project Document)
...
│  ├─ Boiler Nameplate or Combustion-Test Information (Project Document)
...
* Recognizable Business, Shift, Seasonal, or Usage Pattern ← User at `Annual Operational Savings > Annual steam-trap fuel reduction > Annual operating hours > Recognizable Business, Shift, Seasonal, or Usage Pattern`. Pass the exact bound Recognizable Business, Shift, Seasonal, or Usage Pattern to Steam Trap Replacement Annual Operating Hours when computing Annual operating hours, exact or estimated status, schedule formula, analysis year, uncertainty, and source provenance; do not substitute a value from another tree path.
* Detailed Operating Days, Shifts, or Active Season, if known ← User at `Annual Operational Savings > Annual steam-trap fuel reduction > Annual operating hours > Detailed Operating Days, Shifts, or Active Season, if known`. Pass the exact bound Detailed Operating Days, Shifts, or Active Season, if known to Steam Trap Replacement Annual Operating Hours when computing Annual operating hours, exact or estimated status, schedule formula, analysis year, uncertainty, and source provenance; do not substitute a value from another tree path.
* Measured Annual Operating Hours, if known ← Project Document at `Annual Operational Savings > Annual steam-trap fuel reduction > Annual operating hours > Measured Annual Operating Hours, if known`. Pass the exact bound Measured Annual Operating Hours, if known to Steam Trap Replacement Annual Operating Hours when computing Annual operating hours, exact or estimated status, schedule formula, analysis year, uncertainty, and source provenance; do not substitute a value from another tree path.
* Site Location and Business Activity ← Profile at `Annual Operational Savings > Annual steam-trap fuel reduction > Annual operating hours > Site Location and Business Activity`. Pass the exact bound Site Location and Business Activity to Steam Trap Replacement Annual Operating Hours when computing Annual operating hours, exact or estimated status, schedule formula, analysis year, uncertainty, and source provenance; do not substitute a value from another tree path.

**Output Bindings:**

* Annual operating hours, exact or estimated status, schedule formula, analysis year, uncertainty, and source provenance → `annual_pressurized_hours` (hours/year; PER_YEAR) at `Annual Operational Savings > Annual steam-trap fuel reduction > Annual operating hours > Standard 1.1 - Steam Trap Replacement Annual Operating Hours`.
...
5. Retain the Steam Trap Replacement Annual Operating Hours source version, exact fields or model inputs, native units, eligible population, population size, selected-value rule, fallback level, selected record, and warnings.
...
* In-Scope Equipment Count ← User at `Annual Operational Savings > Annual steam-trap fuel reduction > In-Scope Equipment Count`. Pass the exact bound In-Scope Equipment Count to Steam Trap Replacement Engineering Calculation when computing Existing and proposed annual resource use or avoided resource use, with calculator version, input units, and warnings; do not substitute a value from another tree path.
* Failed-trap condition ← User at `Annual Operational Savings > Annual steam-trap fuel reduction > Failed-trap condition`. Pass the exact bound Failed-trap condition to Steam Trap Replacement Engineering Calculation when computing Existing and proposed annual resource use or avoided resource use, with calculator version, input units, and warnings; do not substitute a value from another tree path.
* Leak class ← User at `Annual Operational Savings > Annual steam-trap fuel reduction > Leak class`. Pass the exact bound Leak class to Steam Trap Replacement Engineering Calculation when computing Existing and proposed annual resource use or avoided resource use, with calculator version, input units, and warnings; do not substitute a value from another tree path.
* Steam Pressure from a nameplate, measurement, audit, or contractor specification ← Project Document at `Annual Operational Savings > Annual steam-trap fuel reduction > Documented Steam Pressure from Nameplate, Measurement, Audit, or Contractor Specification`. Pass the exact bound Steam Pressure from a nameplate, measurement, audit, or contractor specification to Steam Trap Replacement Engineering Calculation when computing Existing and proposed annual resource use or avoided resource use, with calculator version, input units, and warnings; do not substitute a value from another tree path.
* Condensate-return condition ← User at `Annual Operational Savings > Annual steam-trap fuel reduction > Condensate-return condition`. Pass the exact bound Condensate-return condition to Steam Trap Replacement Engineering Calculation when computing Existing and proposed annual resource use or avoided resource use, with calculator version, input units, and warnings; do not substitute a value from another tree path.
* Boiler Nameplate or Combustion-Test Information ← Project Document at `Annual Operational Savings > Annual steam-trap fuel reduction > Boiler Nameplate or Combustion-Test Information`. Pass the exact bound Boiler Nameplate or Combustion-Test Information to Steam Trap Replacement Engineering Calculation when computing Existing and proposed annual resource use or avoided resource use, with calculator version, input units, and warnings; do not substitute a value from another tree path.
* Annual operating hours from the connected schedule process ← Standard Output at `Annual Operational Savings > Annual steam-trap fuel reduction > Annual operating hours > Standard 1.1 - Steam Trap Replacement Annual Operating Hours`. Pass the exact bound Annual operating hours from the connected schedule process to Steam Trap Replacement Engineering Calculation when computing Existing and proposed annual resource use or avoided resource use, with calculator version, input units, and warnings; do not substitute a value from another tree path.

**Output Bindings:**

* Existing and proposed annual resource use or avoided resource use, with calculator version, input units, and warnings → `avoided_steam_loss` (mass/year; PER_YEAR) at `Annual Operational Savings > Annual steam-trap fuel reduction > Standard 1.2 - Steam Trap Replacement Engineering Calculation`.
...
2. When an exact technical input is unavailable, use only a source-specific retained equipment or application population with documented filters, numeric rule, unit, scope, and version before running the Steam System Assessment Tool steam-loss calculation; otherwise report the implementation limitation.
3. Run the pinned open-source Steam System Assessment Tool steam-loss calculation baseline and proposed cases using the category formula boundary shown in this card.
...
5. Retain the MEASUR version, Steam System Assessment Tool steam-loss calculation input object, exact and benchmark input provenance, context filters, eligible populations, selection rules, unit conversions, warnings, and baseline and proposed outputs.
...
* **Automation Method:** Map reviewed project evidence into the Steam System Assessment Tool steam-loss calculation input schema, fill unresolved inputs through the single-value authoritative benchmark policy, execute the versioned local module, and preserve its warnings and native outputs.
