...
- **What this category means:** Evaluate operational savings for Duct sealing and duct insulation.
- **What the formula calculates:** duct-loss fraction -> resource avoided -> rate.
- **What RetroFi asks during ordinary screening:** Existing building vintage class; Existing duct location and condition; Proposed sealing and insulation scope.
...
- **What remains unsupported:** Approved Scout ECM definition and source fixture.
- **Why the status is Draft:** Approved Scout ECM definition and source fixture.
- **Decision requested:** Decide whether RetroFi should keep Duct loss reduction at no estimate until this category-specific gate is resolved: Approved Scout ECM definition and source fixture.
...
- **Limitation:** Approved Scout ECM definition and source fixture.
...
### Term: `annual_HVAC_R_r`

- **Unit:** resource-unit/year (`resource_unit_year`)
- **Dimension:** resource_per_time
- **Quantity kind:** resource_rate
- **Formula role:** Affected annual resource basis
- **Resolved by:** Measured end use or user-confirmed bill allocation
- **Exact path:** annual_kwh or annual_therms plus User HVAC share
- **Fallback:** None
- **Evidence:** Direct input or deterministic formula
- **Source location:** Annual HVAC resource by end use and fuel
- **Missing behavior:** NO_ESTIMATE

### Term: `existing_duct_loss_fraction`

- **Unit:** fraction (`fraction`)
- **Dimension:** dimensionless
- **Quantity kind:** ratio
- **Formula role:** Calculates the avoided loss fraction
- **Resolved by:** STD-SCOUT-ECM-SCREEN or measurement
...
### Term: `proposed_duct_loss_fraction`
...
### Term: `duct_loss_reduction_fraction`
...
- Decide whether RetroFi should keep Duct loss reduction at no estimate until this category-specific gate is resolved: Approved Scout ECM definition and source fixture.
