...
│  ├─ Required pressure rise, if known (User)
│  ├─ Existing fan efficiency, if known (User)
│  ├─ Existing motor efficiency, if known (User)
│  ├─ Proposed fan efficiency, if known (User)
...
- Annual fan-system electricity reduction > Required airflow, if known
- Annual fan-system electricity reduction > Required pressure rise, if known
- Annual fan-system electricity reduction > Existing fan efficiency, if known
- Annual fan-system electricity reduction > Existing motor efficiency, if known
- Annual fan-system electricity reduction > Proposed fan efficiency, if known
- Annual fan-system electricity reduction > Proposed motor efficiency, if known
...
- Annual fan-system electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > site.geo coordinates and business schedule context
...
- `measur_calculator_inputs` - **Required:** Every calculator-specific equipment, operating-point, schedule, and resource input shown as an atomic leaf in the applicable category tree; the category contract deterministically selects the calculator ID.
  - **Resolved by:**
    ...
    - **User:** Annual dollar savings > Annual fan-system electricity reduction > Required airflow, if known
    - **User:** Annual dollar savings > Annual fan-system electricity reduction > Required pressure rise, if known
    - **User:** Annual dollar savings > Annual fan-system electricity reduction > Existing fan efficiency, if known
    - **User:** Annual dollar savings > Annual fan-system electricity reduction > Existing motor efficiency, if known
    - **User:** Annual dollar savings > Annual fan-system electricity reduction > Proposed fan efficiency, if known
    - **User:** Annual dollar savings > Annual fan-system electricity reduction > Proposed motor efficiency, if known
...
- `operating_schedule` - **Required:** Recognizable usage or control pattern and available Profile context.
  - **Resolved by:**
    ...
    - **User:** Annual dollar savings > Annual fan-system electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Measured Annual Operating Hours, if known
    - **Profile:** Annual dollar savings > Annual fan-system electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > site.geo coordinates and business schedule context
