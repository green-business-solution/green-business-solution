...
**Purpose:**
Use U.S. Department of Energy - MEASUR to resolve existing fan input power; Proposed fan input power from the listed category inputs.
...
* Existing fan input power
* Proposed fan input power
...
4. Return one selected existing fan input power; Proposed fan input power.
