...
- **What this category means:** Evaluate operational savings for Efficient fan/blower replacement, Efficient ventilation system.
- **What the formula calculates:** input kW difference -> annual kWh -> rate.
- **What RetroFi asks during ordinary screening:** Count of identical units in project scope; Required airflow; Required pressure rise; and 5 more staged screening input(s).
...
- **What remains unsupported:** Exact MEASUR fan adapter and schedule fixture.
- **Why the status is Draft:** Exact MEASUR fan adapter and schedule fixture.
- **Decision requested:** Decide whether RetroFi should keep Fan or ventilation system replacement at no estimate until this category-specific gate is resolved: Exact MEASUR fan adapter and schedule fixture.
...
- **Limitation:** Exact MEASUR fan adapter and schedule fixture.
...
- **Dimension:** count
- **Quantity kind:** count
- **Formula role:** Scopes and annualizes power
...
- **Dimension:** power
- **Quantity kind:** power
- **Formula role:** Calculates fan input power with each efficiency applied once
- **Resolved by:** Exact fan inputs and MEASUR adapter
- **Exact path:** evidence:E-MEASUR-ITC41
- **Fallback:** None
- **Evidence:** E-MEASUR-ITC41 - UNVERIFIED
- **Source location:** ITC-41 fan adapter not selected: Calculator ID, inputs, units, output, function, and golden example missing
- **Missing behavior:** NO_ESTIMATE
...
- **Minimum required inputs:** quantity; airflow and pressure; fan and motor efficiencies; hours.
...
- **Remaining gate:** Exact MEASUR fan adapter and schedule fixture.
- **Golden result:** None
...
│  ├─ Existing fan efficiency (User)
│  ├─ Existing motor efficiency (User)
│  ├─ Proposed fan efficiency (User)
...
- Annual fan-system electricity reduction > In-scope quantity [BR-SCOPE-QUANTITY] > Count of identical units in project scope
- Annual fan-system electricity reduction > Required airflow
- Annual fan-system electricity reduction > Required pressure rise
- Annual fan-system electricity reduction > Existing fan efficiency
- Annual fan-system electricity reduction > Existing motor efficiency
- Annual fan-system electricity reduction > Proposed fan efficiency
- Annual fan-system electricity reduction > Proposed motor efficiency
- Annual fan-system electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Recognizable Business, Shift, Seasonal, or Usage Pattern
...
- Annual fan-system electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Detailed Operating Days, Shifts, or Active Season, if known
- Annual fan-system electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Measured Annual Operating Hours, if known
...
- Annual fan-system electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > site.geo.coordinates and business.primaryActivityText
...
- `measur_calculator_inputs` - **Required:** Every calculator-specific equipment, operating-point, schedule, and resource input shown as an atomic leaf in the applicable category tree; the category contract deterministically selects the calculator ID.
  - **Resolved by:**
    - **User:** Annual dollar savings > Annual fan-system electricity reduction > In-scope quantity [BR-SCOPE-QUANTITY] > Count of identical units in project scope
    - **User:** Annual dollar savings > Annual fan-system electricity reduction > Required airflow
    - **User:** Annual dollar savings > Annual fan-system electricity reduction > Required pressure rise
    - **User:** Annual dollar savings > Annual fan-system electricity reduction > Existing fan efficiency
    - **User:** Annual dollar savings > Annual fan-system electricity reduction > Existing motor efficiency
    - **User:** Annual dollar savings > Annual fan-system electricity reduction > Proposed fan efficiency
    - **User:** Annual dollar savings > Annual fan-system electricity reduction > Proposed motor efficiency
    - **User:** Annual dollar savings > Annual fan-system electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Measured Annual Operating Hours, if known
...
- `operating_schedule` - **Required:** Recognizable usage or control pattern and available Profile context.
  - **Resolved by:**
    - **User:** Annual dollar savings > Annual fan-system electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Recognizable Business, Shift, Seasonal, or Usage Pattern
    - **User:** Annual dollar savings > Annual fan-system electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Measured Annual Operating Hours, if known
    - **Profile:** Annual dollar savings > Annual fan-system electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > site.geo.coordinates and business.primaryActivityText
    - **Standard:** Annual dollar savings > Annual fan-system electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Deterministic annual operating-hours resolution
- `operating_schedule_details` - **Optional:** Detailed operating days, shifts, or active season when known.
  - **Resolved by:**
    - **User:** Annual dollar savings > Annual fan-system electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Detailed Operating Days, Shifts, or Active Season, if known
...
The two taxonomy types share an identical fan-system boundary and calculation tree.
...
- Decide whether RetroFi should keep Fan or ventilation system replacement at no estimate until this category-specific gate is resolved: Exact MEASUR fan adapter and schedule fixture.
