...
**Purpose:**
Use U.S. Department of Energy - MEASUR to resolve measured leak flow; Compressor specific power from the listed category inputs.
...
4. Return one selected measured leak flow; Compressor specific power.
