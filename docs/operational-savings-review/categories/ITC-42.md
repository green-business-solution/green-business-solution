...
- **What this category means:** Evaluate operational savings for Efficient air compressor.
- **What the formula calculates:** annual output × specific-power difference -> kWh -> rate.
- **What RetroFi asks during ordinary screening:** Count of identical units in project scope; Required pressure; Mean flow; and 5 more staged screening input(s).
...
- **What remains unsupported:** Exact MEASUR compressed-air adapter and schedule fixture.
- **Why the status is Draft:** Exact MEASUR compressed-air adapter and schedule fixture.
- **Decision requested:** Decide whether RetroFi should keep Air-compressor specific-power replacement at no estimate until this category-specific gate is resolved: Exact MEASUR compressed-air adapter and schedule fixture.
...
- **Limitation:** Exact MEASUR compressed-air adapter and schedule fixture.
...
- **Dimension:** count
- **Quantity kind:** count
- **Formula role:** Calculates annual flow-hours once before applying specific power
- **Resolved by:** Measured project inputs and explicit schedule
- **Exact path:** User inputs; schedule.explicit_calendar_hours
- **Fallback:** None
...
### Term: `annual_flow_hours`

- **Unit:** flow-unit-hours/year (`flow_unit_hour_per_year`)
- **Dimension:** flow_time_per_time
- **Quantity kind:** annual_activity
- **Formula role:** Calculates annual flow-hours once before applying specific power
- **Resolved by:** Measured project inputs and explicit schedule
- **Exact path:** User inputs; schedule.explicit_calendar_hours
- **Fallback:** None
...
### Term: `specific_power_existing`

- **Unit:** kW/flow-unit (`kilowatt_per_flow_unit`)
- **Dimension:** power_per_flow
- **Quantity kind:** specific_power
- **Formula role:** Existing and proposed power intensity
- **Resolved by:** Measured values or exact MEASUR adapter
- **Exact path:** evidence:E-MEASUR-ITC42
- **Fallback:** None
- **Evidence:** E-MEASUR-ITC42 - UNVERIFIED
- **Source location:** ITC-42 compressed-air specific-power adapter not selected: Calculator ID, inputs, units, output, function, and golden example missing
- **Missing behavior:** NO_ESTIMATE

### Term: `specific_power_proposed`
...
- Decide whether RetroFi should keep Air-compressor specific-power replacement at no estimate until this category-specific gate is resolved: Exact MEASUR compressed-air adapter and schedule fixture.
