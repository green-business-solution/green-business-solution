...
│  ├─ Required pressure, if known (User)
│  ├─ Mean flow, if known (User)
│  ├─ Existing compressor type (User)
│  ├─ Existing compressor specific power, if known (User)
│  ├─ Proposed compressor type (User)
│  ├─ Proposed compressor specific power, if known (User)
...
- Annual compressor electricity reduction > Required pressure, if known
- Annual compressor electricity reduction > Mean flow, if known
- Annual compressor electricity reduction > Existing compressor specific power, if known
- Annual compressor electricity reduction > Proposed compressor specific power, if known
...
- Annual compressor electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > site.geo coordinates and business schedule context
...
- `measur_calculator_inputs` - **Required:** Every calculator-specific equipment, operating-point, schedule, and resource input shown as an atomic leaf in the applicable category tree; the category contract deterministically selects the calculator ID.
  - **Resolved by:**
    ...
    - **User:** Annual dollar savings > Annual compressor electricity reduction > Required pressure, if known
    - **User:** Annual dollar savings > Annual compressor electricity reduction > Mean flow, if known
    - **User:** Annual dollar savings > Annual compressor electricity reduction > Existing compressor type
    - **User:** Annual dollar savings > Annual compressor electricity reduction > Existing compressor specific power, if known
    - **User:** Annual dollar savings > Annual compressor electricity reduction > Proposed compressor type
    - **User:** Annual dollar savings > Annual compressor electricity reduction > Proposed compressor specific power, if known
...
- `operating_schedule` - **Required:** Recognizable usage or control pattern and available Profile context.
  - **Resolved by:**
    ...
    - **User:** Annual dollar savings > Annual compressor electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Measured Annual Operating Hours, if known
    - **Profile:** Annual dollar savings > Annual compressor electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > site.geo coordinates and business schedule context
