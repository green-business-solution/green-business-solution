...
**Purpose:**
Use U.S. Department of Energy - MEASUR to resolve existing compressor specific power; Proposed compressor specific power from the listed category inputs.
...
* Existing compressor specific power
* Proposed compressor specific power
...
4. Return one selected existing compressor specific power; Proposed compressor specific power.
