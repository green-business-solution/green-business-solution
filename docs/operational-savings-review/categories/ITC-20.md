...
- Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Confirmed annual operating hours for the exact equipment or load
- Operating load fraction
- Coincident onsite electric load
- Explicit export rule when export is permitted
...
- Electric efficiency by technology and capacity
...
- `operating_profile` - Annual operating hours, load fraction, or capacity factor.
  - **Resolved by:**
    - **User:** Annual resource value > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Confirmed annual operating hours for the exact equipment or load
