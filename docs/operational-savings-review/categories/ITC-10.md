...
- **What this category means:** Evaluate operational savings for High-efficiency refrigeration equipment.
- **What the formula calculates:** annual kWh difference -> electric rate.
- **What RetroFi asks during ordinary screening:** Count of identical units in project scope; Existing Recognizable Equipment Type or Application; Proposed Product Class or Intended Scope.
- **What RetroFi resolves automatically:** 2 Bill value(s), 2 Standard result(s).
- **Conditional Calculation Gates:** None.
- **What remains unsupported:** Product-family schema fixtures and existing-equipment source.
- **Why the status is Draft:** Product-family schema fixtures and existing-equipment source.
- **Decision requested:** Decide whether RetroFi should keep Refrigeration certified-rating replacement in Draft until this category-specific gate is resolved: Product-family schema fixtures and existing-equipment source.
...
- **Limitation:** Product-family schema fixtures and existing-equipment source.
...
- **Dimension:** count
- **Quantity kind:** count
- **Formula role:** Scopes equipment count
- **Resolved by:** User
...
- **Dimension:** power
- **Quantity kind:** power
- **Formula role:** Annualizes a daily energy field exactly once when the source field is daily
- **Resolved by:** Deterministic annualization for daily certification fields only
- **Exact path:** annual_kWh = daily_kWh × 365
- **Fallback:** None
- **Evidence:** Direct input or deterministic formula
- **Source location:** Certified existing and proposed product resolution
- **Missing behavior:** NO_ESTIMATE

### Term: `daily_kWh`

- **Unit:** kWh/day (`kwh_day`)
- **Dimension:** power
- **Quantity kind:** power
- **Formula role:** Annualizes a daily energy field exactly once when the source field is daily
- **Resolved by:** Deterministic annualization for daily certification fields only
...
### Term: `existing_annual_kWh`

- **Unit:** kWh/unit-year (`kwh_unit_year`)
- **Dimension:** power
- **Quantity kind:** power
- **Formula role:** Existing annual energy
...
- **Dimension:** power
- **Quantity kind:** power
- **Formula role:** Proposed annual energy
...
- Decide whether RetroFi should keep Refrigeration certified-rating replacement in Draft until this category-specific gate is resolved: Product-family schema fixtures and existing-equipment source.
