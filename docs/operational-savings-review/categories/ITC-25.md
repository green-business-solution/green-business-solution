...
|---|---|---|---|---|---|---|---|
| thermal_state_t | thermal-energy and fraction | Exact project design and REopt-compatible dispatch method | User thermal-storage design<br>evidence:E-REOPT-DISPATCH | None | E-REOPT-DISPATCH: UNVERIFIED | Versioned REopt input schema, solver, and result schema - Exact version, fields, and golden result are not pinned | NO_ESTIMATE |
| thermal_state_(t-1) | thermal-energy and fraction | Exact project design and REopt-compatible dispatch method | User thermal-storage design<br>evidence:E-REOPT-DISPATCH | None | E-REOPT-DISPATCH: UNVERIFIED | Versioned REopt input schema, solver, and result schema - Exact version, fields, and golden result are not pinned | NO_ESTIMATE |
| charge_t | thermal-energy and fraction | Exact project design and REopt-compatible dispatch method | User thermal-storage design<br>evidence:E-REOPT-DISPATCH | None | E-REOPT-DISPATCH: UNVERIFIED | Versioned REopt input schema, solver, and result schema - Exact version, fields, and golden result are not pinned | NO_ESTIMATE |
| discharge_t | thermal-energy and fraction | Exact project design and REopt-compatible dispatch method | User thermal-storage design<br>evidence:E-REOPT-DISPATCH | None | E-REOPT-DISPATCH: UNVERIFIED | Versioned REopt input schema, solver, and result schema - Exact version, fields, and golden result are not pinned | NO_ESTIMATE |
| η_charge | thermal-energy and fraction | Exact project design and REopt-compatible dispatch method | User thermal-storage design<br>evidence:E-REOPT-DISPATCH | None | E-REOPT-DISPATCH: UNVERIFIED | Versioned REopt input schema, solver, and result schema - Exact version, fields, and golden result are not pinned | NO_ESTIMATE |
| η_discharge | thermal-energy and fraction | Exact project design and REopt-compatible dispatch method | User thermal-storage design<br>evidence:E-REOPT-DISPATCH | None | E-REOPT-DISPATCH: UNVERIFIED | Versioned REopt input schema, solver, and result schema - Exact version, fields, and golden result are not pinned | NO_ESTIMATE |
| standing_loss_t | thermal-energy and fraction | Exact project design and REopt-compatible dispatch method | User thermal-storage design<br>evidence:E-REOPT-DISPATCH | None | E-REOPT-DISPATCH: UNVERIFIED | Versioned REopt input schema, solver, and result schema - Exact version, fields, and golden result are not pinned | NO_ESTIMATE |
