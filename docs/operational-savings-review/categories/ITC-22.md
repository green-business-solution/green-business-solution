...
- **What this category means:** Evaluate operational savings for Biomass / biogas energy system.
- **What the formula calculates:** fuel-to-power-and-heat balance -> component rates.
- **What RetroFi asks during ordinary screening:** Fuel unit; Conversion technology; Installed capacity; and 3 more staged screening input(s).
- **What RetroFi resolves automatically:** 3 Bill value(s), 1 Standard result(s).
- **Conditional Calculation Gates:** None.
- **What remains unsupported:** Confirmed fuel supply and EPA performance fixture.
- **Why the status is Draft:** Confirmed fuel supply and EPA performance fixture.
- **Decision requested:** Decide whether RetroFi should keep Biomass or biogas resource balance at no estimate until this category-specific gate is resolved: Confirmed fuel supply and EPA performance fixture.
...
- **Limitation:** Confirmed fuel supply and EPA performance fixture.
...
### Term: `annual_available_fuel`

- **Unit:** resource-unit/year (`resource_unit_year`)
- **Dimension:** resource_per_time
- **Quantity kind:** resource_rate
- **Formula role:** Caps annual input fuel
- **Resolved by:** Measured or contracted project fuel supply
- **Exact path:** User fuel availability and schedule
- **Fallback:** None
- **Evidence:** Direct input or deterministic formula
- **Source location:** Confirmed annual fuel availability, if known (User); Operating schedule (User); Scheduled input fuel
- **Missing behavior:** NO_ESTIMATE

### Term: `scheduled_input_fuel`
...
### Term: `lower_heating_value`

- **Unit:** energy/fuel-unit (`energy_fuel_unit`)
- **Dimension:** energy
- **Quantity kind:** energy
- **Formula role:** Calculates electricity generation once
- **Resolved by:** Exact fuel assay and EPA or project performance
- **Exact path:** User heating value; evidence:E-EPA-CHP
- **Fallback:** None
...
### Term: `recoverable_heat_fraction`

- **Unit:** fraction (`fraction`)
- **Dimension:** dimensionless
- **Quantity kind:** ratio
- **Formula role:** Caps heat and converts to displaced fuel
...
- **Dimension:** energy
- **Quantity kind:** energy
- **Formula role:** Executes the displaced-boiler fuel conversion exactly once before pricing
...
- **Dimension:** energy_per_time
- **Quantity kind:** energy
- **Formula role:** Caps and values electricity, displaced boiler fuel, and input fuel
...
- **Fallback:** None
- **Evidence:** Direct input or deterministic formula
- **Source location:** Annual biomass or biogas resource value; Coincident onsite electric-load constraint, if known (User); Avoidable marginal resource price
...
- Decide whether RetroFi should keep Biomass or biogas resource balance at no estimate until this category-specific gate is resolved: Confirmed fuel supply and EPA performance fixture.
