...
* Confirmed annual fuel availability, if known ← User at `Annual Operational Savings > Confirmed annual fuel availability, if known`. Pass the exact bound Confirmed annual fuel availability, if known to Biomass or Biogas Energy System Performance Balance when computing Annual electricity generation, input fuel, and useful recovered heat for the selected technology and capacity; do not substitute a value from another tree path.
* Fuel unit ← User at `Annual Operational Savings > Fuel unit`. Pass the exact bound Fuel unit to Biomass or Biogas Energy System Performance Balance when computing Annual electricity generation, input fuel, and useful recovered heat for the selected technology and capacity; do not substitute a value from another tree path.
* Fuel lower heating value, if known from a nameplate, measurement, audit, or contractor specification ← Project Document at `Annual Operational Savings > Documented Fuel lower heating value, if known from Nameplate, Measurement, Audit, or Contractor Specification`. Pass the exact bound Fuel lower heating value, if known from a nameplate, measurement, audit, or contractor specification to Biomass or Biogas Energy System Performance Balance when computing Annual electricity generation, input fuel, and useful recovered heat for the selected technology and capacity; do not substitute a value from another tree path.
* Conversion technology ← Linked Opportunity at `Annual Operational Savings > Conversion technology`. Pass the exact bound Conversion technology to Biomass or Biogas Energy System Performance Balance when computing Annual electricity generation, input fuel, and useful recovered heat for the selected technology and capacity; do not substitute a value from another tree path.
* Selected Unit Model, if known ← Linked Opportunity at `Annual Operational Savings > Selected Unit Model, if known`. Pass the exact bound Selected Unit Model, if known to Biomass or Biogas Energy System Performance Balance when computing Annual electricity generation, input fuel, and useful recovered heat for the selected technology and capacity; do not substitute a value from another tree path.
* Installed capacity ← Linked Opportunity at `Annual Operational Savings > Installed capacity`. Pass the exact bound Installed capacity to Biomass or Biogas Energy System Performance Balance when computing Annual electricity generation, input fuel, and useful recovered heat for the selected technology and capacity; do not substitute a value from another tree path.
* Coincident onsite electric-load constraint, if known ← Project Document at `Annual Operational Savings > Documented Coincident onsite electric-load constraint, if known from Nameplate, Measurement, Audit, or Contractor Specification`. Pass the exact bound Coincident onsite electric-load constraint, if known to Biomass or Biogas Energy System Performance Balance when computing Annual electricity generation, input fuel, and useful recovered heat for the selected technology and capacity; do not substitute a value from another tree path.
* Coincident useful thermal-load constraint ← Project Document at `Annual Operational Savings > Documented Coincident useful thermal-load constraint from Nameplate, Measurement, Audit, or Contractor Specification`. Pass the exact bound Coincident useful thermal-load constraint to Biomass or Biogas Energy System Performance Balance when computing Annual electricity generation, input fuel, and useful recovered heat for the selected technology and capacity; do not substitute a value from another tree path.
* Existing Boiler Nameplate or Combustion-Test Information, if known ← Project Document at `Annual Operational Savings > Existing Boiler Nameplate or Combustion-Test Information, if known`. Pass the exact bound Existing Boiler Nameplate or Combustion-Test Information, if known to Biomass or Biogas Energy System Performance Balance when computing Annual electricity generation, input fuel, and useful recovered heat for the selected technology and capacity; do not substitute a value from another tree path.

**Output Bindings:**

* Annual electricity generation, input fuel, and useful recovered heat for the selected technology and capacity → `avoided_boiler_fuel` (fuel-unit/year; PER_YEAR) at `Annual Operational Savings > Standard 1.1 - Biomass or Biogas Energy System Performance Balance`.
