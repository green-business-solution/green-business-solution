...
- **What this category means:** Evaluate operational savings for High-efficiency motor replacement.
- **What the formula calculates:** input-power difference -> annual kWh -> rate.
- **What RetroFi asks during ordinary screening:** Count of identical units in project scope; Motor rated shaft power; Motor rated speed; and 4 more staged screening input(s).
...
- **What remains unsupported:** Exact MEASUR motor adapter and schedule fixture.
- **Why the status is Draft:** Exact MEASUR motor adapter and schedule fixture.
- **Decision requested:** Decide whether RetroFi should keep Motor input-power efficiency replacement at no estimate until this category-specific gate is resolved: Exact MEASUR motor adapter and schedule fixture.
...
- **Limitation:** Exact MEASUR motor adapter and schedule fixture.
...
- **Dimension:** count
- **Quantity kind:** count
- **Formula role:** Scopes and annualizes shaft load
- **Resolved by:** Exact project inputs and explicit schedule
...
- **Dimension:** dimensionless
- **Quantity kind:** ratio
- **Formula role:** Converts shaft power to input power once
- **Resolved by:** Exact ratings or MEASUR motor adapter
- **Exact path:** evidence:E-MEASUR-ITC38
- **Fallback:** None
- **Evidence:** E-MEASUR-ITC38 - UNVERIFIED
- **Source location:** ITC-38 motor adapter not selected: Calculator ID, inputs, units, output, function, and golden example missing
- **Missing behavior:** NO_ESTIMATE
...
- **Minimum required inputs:** quantity; shaft kW; load fraction; existing/proposed efficiency; hours.
- **Exact scenario:** insufficient-data.
- **Source fixture:** None.
- **Low/base/high calculation:** Explicit inputs only.
- **Final result path:** input-power difference -> annual kWh -> rate
- **Uncertainty:** High.
- **Executable golden fixture:** No.
- **Remaining gate:** Exact MEASUR motor adapter and schedule fixture.
- **Golden result:** None
...
- Annual motor electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Recognizable Business, Shift, Seasonal, or Usage Pattern
...
- Annual motor electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Detailed Operating Days, Shifts, or Active Season, if known
- Annual motor electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Measured Annual Operating Hours, if known
...
- Annual motor electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > site.geo.coordinates and business.primaryActivityText
...
- `measur_calculator_inputs` - **Required:** Every calculator-specific equipment, operating-point, schedule, and resource input shown as an atomic leaf in the applicable category tree; the category contract deterministically selects the calculator ID.
  - **Resolved by:**
    ...
    - **User:** Annual dollar savings > Annual motor electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Measured Annual Operating Hours, if known
...
- `operating_schedule` - **Required:** Recognizable usage or control pattern and available Profile context.
  - **Resolved by:**
    - **User:** Annual dollar savings > Annual motor electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Recognizable Business, Shift, Seasonal, or Usage Pattern
    - **User:** Annual dollar savings > Annual motor electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Measured Annual Operating Hours, if known
    - **Profile:** Annual dollar savings > Annual motor electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > site.geo.coordinates and business.primaryActivityText
    - **Standard:** Annual dollar savings > Annual motor electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Deterministic annual operating-hours resolution
- `operating_schedule_details` - **Optional:** Detailed operating days, shifts, or active season when known.
  - **Resolved by:**
    - **User:** Annual dollar savings > Annual motor electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Detailed Operating Days, Shifts, or Active Season, if known
...
- Decide whether RetroFi should keep Motor input-power efficiency replacement at no estimate until this category-specific gate is resolved: Exact MEASUR motor adapter and schedule fixture.
