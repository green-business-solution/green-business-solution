...
│  ├─ Motor rated shaft power, if known (User)
│  ├─ Motor rated speed, if known (User)
...
- Annual motor electricity reduction > Motor rated shaft power, if known
- Annual motor electricity reduction > Motor rated speed, if known
- Annual motor electricity reduction > Operating load fraction, if known
...
- Annual motor electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > site.geo coordinates and business schedule context
...
- `measur_calculator_inputs` - **Required:** Every calculator-specific equipment, operating-point, schedule, and resource input shown as an atomic leaf in the applicable category tree; the category contract deterministically selects the calculator ID.
  - **Resolved by:**
    ...
    - **User:** Annual dollar savings > Annual motor electricity reduction > Motor rated shaft power, if known
    - **User:** Annual dollar savings > Annual motor electricity reduction > Motor rated speed, if known
    - **User:** Annual dollar savings > Annual motor electricity reduction > Operating load fraction, if known
...
- `operating_schedule` - **Required:** Recognizable usage or control pattern and available Profile context.
  - **Resolved by:**
    ...
    - **User:** Annual dollar savings > Annual motor electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Measured Annual Operating Hours, if known
    - **Profile:** Annual dollar savings > Annual motor electricity reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > site.geo coordinates and business schedule context
