...
- **Optional Known-Detail count:** 10
...
│  ├─ Annual Cycles per Unit, if known (User)
│  ├─ Representative Load per Cycle, if known (User)
│  ├─ Hot-Water Fraction, if known (User)
│  ├─ Hot-water temperature rise, if known (User)
│  ├─ Water-heating resource (User)
│  ├─ Water-heater efficiency, if known (User)
│  ├─ Separately reported or measured machine electricity per cycle, if known (User)
...
- Annual commercial laundry resource reduction > Annual Cycles per Unit, if known
- Annual commercial laundry resource reduction > Representative Load per Cycle, if known
- Annual commercial laundry resource reduction > Hot-Water Fraction, if known
- Annual commercial laundry resource reduction > Hot-water temperature rise, if known
- Annual commercial laundry resource reduction > Water-heater efficiency, if known
- Annual commercial laundry resource reduction > Separately reported or measured machine electricity per cycle, if known

Optional Known Details replace the corresponding Standard estimate when supplied and validated.

### Profile Inputs

- Annual commercial laundry resource reduction > Certified existing and proposed product resolution [BR-CERTIFIED-PRODUCT-RESOLUTION] > Linked Opportunity
...
- `linked_opportunity` - **Conditional:** Product, certification, class, or minimum-performance restriction when a Linked Opportunity supplies one. Applies only in the documented scenario.
  - **Resolved by:**
    - **Profile:** Annual dollar savings > Annual commercial laundry resource reduction > Certified existing and proposed product resolution [BR-CERTIFIED-PRODUCT-RESOLUTION] > Linked Opportunity
- `product_usage_pattern` - **Conditional:** Recognizable operating pattern and exact activity or idle values when the category formula uses certified active and idle ratings. Applies only in the documented scenario.
  - **Resolved by:**
    - **User:** Annual dollar savings > Annual commercial laundry resource reduction > Recognizable Laundry Usage Pattern
    - **User:** Annual dollar savings > Annual commercial laundry resource reduction > Annual Cycles per Unit, if known
    - **User:** Annual dollar savings > Annual commercial laundry resource reduction > Representative Load per Cycle, if known
    - **User:** Annual dollar savings > Annual commercial laundry resource reduction > Hot-Water Fraction, if known
