...
- Annual fuel reduction > Annual boiler fuel > Annual billed resource r [BR-ANNUAL-BILL-RESOURCE] > annual_kwh, annual_therms, annual_water_use with water_unit, or annual_gallons for resource r
...
- Annual fuel reduction > MEASUR baseline and proposed fuel result
...
- Resolve before approval: The status remains DRAFT until the exact MEASUR adapter and minimum control inputs are fixture-tested.
