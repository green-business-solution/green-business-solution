...
**Purpose:**
Use U.S. Department of Energy - MEASUR to resolve baseline annual boiler fuel; Proposed annual boiler fuel from the listed category inputs.
...
* Baseline annual boiler fuel
* Proposed annual boiler fuel
...
4. Return one selected baseline annual boiler fuel; Proposed annual boiler fuel.
