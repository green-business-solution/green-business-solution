...
- **What this category means:** Evaluate operational savings for Demand-controlled kitchen ventilation.
- **What the formula calculates:** fan and makeup-air deltas -> matched rates.
- **What RetroFi asks during ordinary screening:** Count of identical units in project scope; Existing fan input power; Existing Design Airflow; and 5 more staged screening input(s).
- **What RetroFi resolves automatically:** 2 Profile value(s), 3 Bill value(s), 2 Standard result(s).
- **Conditional Calculation Gates:** None.
- **What remains unsupported:** Exact MEASUR fan/HVAC adapter and golden fixture.
- **Why the status is Draft:** Exact MEASUR fan/HVAC adapter and golden fixture.
- **Decision requested:** Decide whether RetroFi should keep Demand-controlled kitchen ventilation at no estimate until this category-specific gate is resolved: Exact MEASUR fan/HVAC adapter and golden fixture.
...
- **Limitation:** Exact MEASUR fan/HVAC adapter and golden fixture.
...
- **Dimension:** count
- **Quantity kind:** count
- **Formula role:** Scopes and weights operating periods
...
- **Unit:** hours/period (`hours_period`)
- **Dimension:** time
...
### Term: `airflow_fraction`

- **Unit:** fraction (`fraction`)
- **Dimension:** dimensionless
- **Quantity kind:** ratio
- **Formula role:** Applies the cubic law only to shaft power and converts to electrical input with explicit efficiencies
- **Resolved by:** Exact fan inputs and MEASUR adapter
- **Exact path:** evidence:E-MEASUR-ITC37
- **Fallback:** None
- **Evidence:** E-MEASUR-ITC37 - UNVERIFIED
- **Source location:** ITC-37 fan and HVAC adapter not selected: Calculator ID, inputs, units, output, function, and golden example missing
- **Missing behavior:** NO_ESTIMATE

### Term: `fan_shaft_power_fraction`
...
### Term: `avoided_makeup_air_R_r`

- **Unit:** resource-unit/year (`resource_unit_year`)
- **Dimension:** resource_per_time
- **Quantity kind:** resource_rate
- **Formula role:** Thermal makeup-air component
- **Resolved by:** Exact HVAC method and climate/load inputs
- **Exact path:** evidence:E-MEASUR-ITC37
- **Fallback:** None
- **Evidence:** E-MEASUR-ITC37 - UNVERIFIED
- **Source location:** ITC-37 fan and HVAC adapter not selected: Calculator ID, inputs, units, output, function, and golden example missing
...
- **Quantity kind:** price
- **Formula role:** Values fan and thermal resources
...
- Annual kitchen ventilation fan and makeup-air resource reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Recognizable Business, Shift, Seasonal, or Usage Pattern
...
- `operating_schedule_details` - **Optional:** Detailed operating days, shifts, or active season when known.
  - **Resolved by:**
    - **User:** Annual dollar savings > Annual kitchen ventilation fan and makeup-air resource reduction > Annual operating hours [BR-ANNUAL-OPERATING-HOURS] > Detailed Operating Days, Shifts, or Active Season, if known
...
- Decide whether RetroFi should keep Demand-controlled kitchen ventilation at no estimate until this category-specific gate is resolved: Exact MEASUR fan/HVAC adapter and golden fixture.
