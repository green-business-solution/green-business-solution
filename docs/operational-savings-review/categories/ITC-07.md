...
- **What this category means:** Evaluate operational savings for High-efficiency gas water heater.
...
- **What remains unsupported:** Existing-product fixture and end-use allocation.
- **Why the status is Draft:** Existing-product fixture and end-use allocation.
- **Decision requested:** Decide whether RetroFi should keep Gas water-heater efficiency replacement at no estimate until this category-specific gate is resolved: Existing-product fixture and end-use allocation.
...
- **Limitation:** Existing-product fixture and end-use allocation.
...
### Term: `current_annual_gas`

- **Unit:** therms/year (`therms_year`)
- **Dimension:** resource_per_time
- **Quantity kind:** resource_rate
- **Formula role:** Existing annual gas input
- **Resolved by:** Measured end use or user-confirmed bill allocation
- **Exact path:** utilityExtractedValues[].fieldId=annual_therms plus User water-heating share
- **Fallback:** None
- **Evidence:** Direct input or deterministic formula
- **Source location:** Current annual water-heating gas
...
- **Quantity kind:** ratio
- **Formula role:** Existing efficiency
- **Resolved by:** Exact existing product or measurement
...
- **Dimension:** dimensionless
- **Quantity kind:** ratio
- **Formula role:** Proposed efficiency
- **Resolved by:** Exact proposed product
...
- **Minimum required inputs:** water-heating gas allocation; existing efficiency; proposed efficiency.
...
- **Remaining gate:** Existing-product fixture and end-use allocation.
- **Golden result:** None
...
- Annual gas reduction > Certified existing and proposed product resolution [BR-CERTIFIED-PRODUCT-RESOLUTION] > Existing Recognizable Equipment Type or Application
- Annual gas reduction > Certified existing and proposed product resolution [BR-CERTIFIED-PRODUCT-RESOLUTION] > Proposed Product Class or Intended Scope
...
- Annual gas reduction > Current annual water-heating gas > Water-heating share, if known
- Annual gas reduction > Certified existing and proposed product resolution [BR-CERTIFIED-PRODUCT-RESOLUTION] > Existing Model, if known
- Annual gas reduction > Certified existing and proposed product resolution [BR-CERTIFIED-PRODUCT-RESOLUTION] > Existing Capacity or Size Class, if known
- Annual gas reduction > Certified existing and proposed product resolution [BR-CERTIFIED-PRODUCT-RESOLUTION] > Selected Proposed Model, if known
- Annual gas reduction > Certified existing and proposed product resolution [BR-CERTIFIED-PRODUCT-RESOLUTION] > Proposed Capacity or Size Class, if known
...
- Annual gas reduction > Current annual water-heating gas > Annual billed resource r [BR-ANNUAL-BILL-RESOURCE] > annual_therms for gas
...
- `ccms_product_context` - **Required:** Recognizable product group or application and proposed scope needed to select a compatible equipment class.
  - **Resolved by:**
    - **User:** Annual dollar savings > Annual gas reduction > Certified existing and proposed product resolution [BR-CERTIFIED-PRODUCT-RESOLUTION] > Existing Recognizable Equipment Type or Application
    - **User:** Annual dollar savings > Annual gas reduction > Certified existing and proposed product resolution [BR-CERTIFIED-PRODUCT-RESOLUTION] > Proposed Product Class or Intended Scope
- `ccms_exact_product` - **Optional:** Exact manufacturer, basic model number, certified rating, and capacity or size when known.
  - **Resolved by:**
    - **User:** Annual dollar savings > Annual gas reduction > Certified existing and proposed product resolution [BR-CERTIFIED-PRODUCT-RESOLUTION] > Existing Model, if known
    - **User:** Annual dollar savings > Annual gas reduction > Certified existing and proposed product resolution [BR-CERTIFIED-PRODUCT-RESOLUTION] > Existing Capacity or Size Class, if known
    - **User:** Annual dollar savings > Annual gas reduction > Certified existing and proposed product resolution [BR-CERTIFIED-PRODUCT-RESOLUTION] > Selected Proposed Model, if known
    - **User:** Annual dollar savings > Annual gas reduction > Certified existing and proposed product resolution [BR-CERTIFIED-PRODUCT-RESOLUTION] > Proposed Capacity or Size Class, if known
- `linked_opportunity` - **Conditional:** Product, certification, class, or minimum-performance restriction when a Linked Opportunity supplies one. Applies only in the documented scenario.
  - **Resolved by:**
    - **Derived:** Annual dollar savings > Annual gas reduction > Certified existing and proposed product resolution [BR-CERTIFIED-PRODUCT-RESOLUTION] > Linked Opportunity
...
- Decide whether RetroFi should keep Gas water-heater efficiency replacement at no estimate until this category-specific gate is resolved: Existing-product fixture and end-use allocation.
