...
|---|---|---|---|---|---|---|---|
| current_annual_gas | therms/year | Measured end use or user-confirmed bill allocation | utilityExtractedValues[].fieldId=annual_therms plus User water-heating share | None | Direct input or formula | Current annual water-heating gas | NO_ESTIMATE |
| η_existing | fraction | Exact existing product or measurement | User Existing Model | None | E-CCMS-EXISTING-UNSUPPORTED: UNSUPPORTED | No reviewed retained historical export - No installed-population table or historical-retention proof | NO_ESTIMATE |
| η_proposed | fraction | Exact proposed product | User Selected Proposed Model | None | E-CCMS-CURRENT: UNVERIFIED<br>E-ENERGY-STAR-OTHER: UNVERIFIED | Product-specific analyst export and DOE test-result template - Product-specific fields are not pinned until an export and template fixture are reviewed<br>Commercial clothes washer, ice machine, cooking, and EVSE datasets - Product-specific field schemas are listed in the registry but have not all been captured as fixtures | NO_ESTIMATE |
| p_gas | USD/therm | Bill | gas-volumetric: utilityExtractedValues[].fieldId=average_cost_per_therm<br>gas-volumetric: utilityExtractedValues[].fieldId=gas_delivery_charges<br>gas-volumetric: utilityExtractedValues[].fieldId=gas_procurement_charges | None | Direct input or formula | Gas volumetric charge | RETURN_THERMS_WITHOUT_DOLLAR_VALUE |
