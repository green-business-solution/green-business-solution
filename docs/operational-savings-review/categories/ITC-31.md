...
- **What this category means:** Evaluate operational savings for Fleet telematics / charging management system.
- **What the formula calculates:** unmanaged and managed dispatch bills -> USD/year.
- **What RetroFi asks during ordinary screening:** Timestamped Green Button interval kW or kWh artifact; no current canonical bill-dictionary field; Interval timezone and daylight-saving treatment from the uploaded interval artifact; Verified tariff calendar for the modeled interval import energy; the current bill parser has no complete canonical tariff artifact; and 8 more staged screening input(s).
- **What RetroFi resolves automatically:** 4 Bill value(s), 1 Standard result(s).
- **Conditional Calculation Gates:** None.
- **What remains unsupported:** Fleet availability schema, counterfactual decision, and REopt fixture.
- **Why the status is Draft:** Fleet availability schema, counterfactual decision, and REopt fixture.
- **Decision requested:** Decide whether RetroFi should keep Managed fleet-charging interval shift at no estimate until this category-specific gate is resolved: Fleet availability schema, counterfactual decision, and REopt fixture.
...
- **Limitation:** Fleet availability schema, counterfactual decision, and REopt fixture.
...
### Term: `available_intervals`

- **Unit:** interval set (`interval_set`)
- **Dimension:** declared
- **Quantity kind:** numeric
- **Formula role:** Departure-energy constraint
- **Resolved by:** Exact fleet availability and energy requirements
- **Exact path:** User arrival, departure, and required energy
- **Fallback:** None
- **Evidence:** Direct input or deterministic formula
- **Source location:** Required energy by departure; Managed charging template
...
### Term: `required_departure_energy`

- **Unit:** and kWh (`and_kwh`)
- **Dimension:** energy
...
- Decide whether RetroFi should keep Managed fleet-charging interval shift at no estimate until this category-specific gate is resolved: Fleet availability schema, counterfactual decision, and REopt fixture.
