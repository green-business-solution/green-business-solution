...
* Recognizable Business, Shift, Seasonal, or Usage Pattern ← User at `Annual Operational Cost Impact > Annual filtration fan electricity change > Annual operating hours > Recognizable Business, Shift, Seasonal, or Usage Pattern`. Pass the exact bound Recognizable Business, Shift, Seasonal, or Usage Pattern to Air Filtration System Annual Operating Hours when computing Annual operating hours, exact or estimated status, schedule formula, analysis year, uncertainty, and source provenance; do not substitute a value from another tree path.
* Detailed Operating Days, Shifts, or Active Season, if known ← User at `Annual Operational Cost Impact > Annual filtration fan electricity change > Annual operating hours > Detailed Operating Days, Shifts, or Active Season, if known`. Pass the exact bound Detailed Operating Days, Shifts, or Active Season, if known to Air Filtration System Annual Operating Hours when computing Annual operating hours, exact or estimated status, schedule formula, analysis year, uncertainty, and source provenance; do not substitute a value from another tree path.
* Measured Annual Operating Hours, if known ← Project Document at `Annual Operational Cost Impact > Annual filtration fan electricity change > Annual operating hours > Measured Annual Operating Hours, if known`. Pass the exact bound Measured Annual Operating Hours, if known to Air Filtration System Annual Operating Hours when computing Annual operating hours, exact or estimated status, schedule formula, analysis year, uncertainty, and source provenance; do not substitute a value from another tree path.
* Site Location and Business Activity ← Profile at `Annual Operational Cost Impact > Annual filtration fan electricity change > Annual operating hours > Site Location and Business Activity`. Pass the exact bound Site Location and Business Activity to Air Filtration System Annual Operating Hours when computing Annual operating hours, exact or estimated status, schedule formula, analysis year, uncertainty, and source provenance; do not substitute a value from another tree path.

**Output Bindings:**

* Annual operating hours, exact or estimated status, schedule formula, analysis year, uncertainty, and source provenance → `annual_hours` (hours/year; PER_YEAR) at `Annual Operational Cost Impact > Annual filtration fan electricity change > Annual operating hours > Standard 1.1 - Air Filtration System Annual Operating Hours`.
...
* In-Scope Equipment Count ← User at `Annual Operational Cost Impact > Annual filtration fan electricity change > In-Scope Equipment Count`. Pass the exact bound In-Scope Equipment Count to Air Filtration System Engineering Calculation when computing Existing and proposed annual resource use or avoided resource use, with calculator version, input units, and warnings; do not substitute a value from another tree path.
* Required airflow from a nameplate, measurement, audit, or contractor specification ← Project Document at `Annual Operational Cost Impact > Annual filtration fan electricity change > Documented Required airflow from Nameplate, Measurement, Audit, or Contractor Specification`. Pass the exact bound Required airflow from a nameplate, measurement, audit, or contractor specification to Air Filtration System Engineering Calculation when computing Existing and proposed annual resource use or avoided resource use, with calculator version, input units, and warnings; do not substitute a value from another tree path.
* Clean-filter pressure rise from a nameplate, measurement, audit, or contractor specification ← Project Document at `Annual Operational Cost Impact > Annual filtration fan electricity change > Documented Clean-filter pressure rise from Nameplate, Measurement, Audit, or Contractor Specification`. Pass the exact bound Clean-filter pressure rise from a nameplate, measurement, audit, or contractor specification to Air Filtration System Engineering Calculation when computing Existing and proposed annual resource use or avoided resource use, with calculator version, input units, and warnings; do not substitute a value from another tree path.
* Loaded-filter pressure rise from a nameplate, measurement, audit, or contractor specification ← Project Document at `Annual Operational Cost Impact > Annual filtration fan electricity change > Documented Loaded-filter pressure rise from Nameplate, Measurement, Audit, or Contractor Specification`. Pass the exact bound Loaded-filter pressure rise from a nameplate, measurement, audit, or contractor specification to Air Filtration System Engineering Calculation when computing Existing and proposed annual resource use or avoided resource use, with calculator version, input units, and warnings; do not substitute a value from another tree path.
* Existing fan input data ← Project Document at `Annual Operational Cost Impact > Annual filtration fan electricity change > Existing fan input data`. Pass the exact bound Existing fan input data to Air Filtration System Engineering Calculation when computing Existing and proposed annual resource use or avoided resource use, with calculator version, input units, and warnings; do not substitute a value from another tree path.
* Existing filtration input data ← Project Document at `Annual Operational Cost Impact > Annual filtration fan electricity change > Existing fan input data`. Pass the exact bound Existing filtration input data to Air Filtration System Engineering Calculation when computing Existing and proposed annual resource use or avoided resource use, with calculator version, input units, and warnings; do not substitute a value from another tree path.
* Proposed fan input data ← Linked Opportunity at `Annual Operational Cost Impact > Annual filtration fan electricity change > Proposed fan input data`. Pass the exact bound Proposed fan input data to Air Filtration System Engineering Calculation when computing Existing and proposed annual resource use or avoided resource use, with calculator version, input units, and warnings; do not substitute a value from another tree path.
* Proposed filtration input data ← Linked Opportunity at `Annual Operational Cost Impact > Annual filtration fan electricity change > Proposed fan input data`. Pass the exact bound Proposed filtration input data to Air Filtration System Engineering Calculation when computing Existing and proposed annual resource use or avoided resource use, with calculator version, input units, and warnings; do not substitute a value from another tree path.
* Annual operating hours from the connected schedule process ← Standard Output at `Annual Operational Cost Impact > Annual filtration fan electricity change > Annual operating hours > Standard 1.1 - Air Filtration System Annual Operating Hours`. Pass the exact bound Annual operating hours from the connected schedule process to Air Filtration System Engineering Calculation when computing Existing and proposed annual resource use or avoided resource use, with calculator version, input units, and warnings; do not substitute a value from another tree path.

**Output Bindings:**

* Existing and proposed annual resource use or avoided resource use, with calculator version, input units, and warnings → `air_power_conversion_factor` (kW/(flow-unit × pressure-unit); PER_YEAR) at `Annual Operational Cost Impact > Annual filtration fan electricity change > Standard 1.2 - Air Filtration System Engineering Calculation`.
