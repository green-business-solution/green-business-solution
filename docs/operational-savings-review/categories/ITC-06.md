...
- **What this category means:** Evaluate operational savings for Heat pump water heater.
- **What the formula calculates:** thermal load -> resource switch -> matched rates.
...
- **What remains unsupported:** Existing and proposed exact-product fixtures and deterministic resource selection.
- **Why the status is Draft:** Existing and proposed exact-product fixtures and deterministic resource selection.
- **Decision requested:** Decide whether RetroFi should keep Heat-pump water-heater resource switching at no estimate until this category-specific gate is resolved: Existing and proposed exact-product fixtures and deterministic resource selection.
...
- **Limitation:** Existing and proposed exact-product fixtures and deterministic resource selection.
...
### Term: `current_annual_input`

- **Unit:** energy/year (`energy_year`)
- **Dimension:** energy_per_time
- **Quantity kind:** energy
- **Formula role:** Existing input removed by complete replacement
- **Resolved by:** Measured end use or user-confirmed bill allocation
- **Exact path:** annual_kwh or annual_therms plus User water-heating share
- **Fallback:** None
- **Evidence:** Direct input or deterministic formula
- **Source location:** Avoided existing water-heating resource
- **Missing behavior:** NO_ESTIMATE

### Term: `avoided_existing_resource`
...
- **Quantity kind:** ratio
- **Formula role:** Converts existing input to delivered hot-water load
- **Resolved by:** Exact existing product or measurement plus formula
- **Exact path:** User Existing Model or measured efficiency
- **Fallback:** None
...
### Term: `UEF_or_COP_proposed`

- **Unit:** fraction (`fraction`)
- **Dimension:** dimensionless
- **Quantity kind:** ratio
- **Formula role:** Calculates proposed electricity
- **Resolved by:** Exact proposed product plus formula
- **Exact path:** User Selected Proposed Model
- **Fallback:** None
- **Evidence:** E-CCMS-CURRENT - UNVERIFIED; E-ENERGY-STAR-OTHER - UNVERIFIED
- **Source location:** Product-specific analyst export and DOE test-result template: Product-specific fields are not pinned until an export and template fixture are reviewed; Commercial clothes washer, ice machine, cooking, and EVSE datasets: Product-specific field schemas are listed in the registry but have not all been captured as fixtures
- **Missing behavior:** NO_ESTIMATE
...
- **Dimension:** energy
- **Quantity kind:** energy
- **Formula role:** Executes to_energy exactly once before applying existing efficiency
...
- **Quantity kind:** price
- **Formula role:** Values avoided existing resource and added electricity
- **Resolved by:** Bill
...
- **Minimum required inputs:** allocated water-heating input; existing efficiency; proposed UEF or COP; existing resource.
- **Exact scenario:** insufficient-data.
- **Source fixture:** None.
- **Low/base/high calculation:** Exact values only.
- **Final result path:** thermal load -> resource switch -> matched rates
- **Uncertainty:** High.
- **Executable golden fixture:** No.
- **Remaining gate:** Existing and proposed exact-product fixtures and deterministic resource selection.
- **Golden result:** None
...
- Added heat-pump water-heater electricity > Certified existing and proposed product resolution [BR-CERTIFIED-PRODUCT-RESOLUTION] > Existing Recognizable Equipment Type or Application
- Added heat-pump water-heater electricity > Certified existing and proposed product resolution [BR-CERTIFIED-PRODUCT-RESOLUTION] > Proposed Product Class or Intended Scope
...
- Avoided existing water-heating resource > Water-heating share, if known
- Added heat-pump water-heater electricity > Certified existing and proposed product resolution [BR-CERTIFIED-PRODUCT-RESOLUTION] > Existing Model, if known
- Added heat-pump water-heater electricity > Certified existing and proposed product resolution [BR-CERTIFIED-PRODUCT-RESOLUTION] > Existing Capacity or Size Class, if known
- Added heat-pump water-heater electricity > Certified existing and proposed product resolution [BR-CERTIFIED-PRODUCT-RESOLUTION] > Selected Proposed Model, if known
- Added heat-pump water-heater electricity > Certified existing and proposed product resolution [BR-CERTIFIED-PRODUCT-RESOLUTION] > Proposed Capacity or Size Class, if known
...
- Avoided existing water-heating resource > Annual billed resource r [BR-ANNUAL-BILL-RESOURCE] > annual_kwh for electricity
- Avoided existing water-heating resource > Annual billed resource r [BR-ANNUAL-BILL-RESOURCE] > annual_therms for gas
- Avoided existing water-heating resource > Annual billed resource r [BR-ANNUAL-BILL-RESOURCE] > billing_period_start
- Avoided existing water-heating resource > Annual billed resource r [BR-ANNUAL-BILL-RESOURCE] > billing_period_end
...
- `ccms_product_context` - **Required:** Recognizable product group or application and proposed scope needed to select a compatible equipment class.
  - **Resolved by:**
    - **User:** Annual dollar savings > Added heat-pump water-heater electricity > Certified existing and proposed product resolution [BR-CERTIFIED-PRODUCT-RESOLUTION] > Existing Recognizable Equipment Type or Application
    - **User:** Annual dollar savings > Added heat-pump water-heater electricity > Certified existing and proposed product resolution [BR-CERTIFIED-PRODUCT-RESOLUTION] > Proposed Product Class or Intended Scope
- `ccms_exact_product` - **Optional:** Exact manufacturer, basic model number, certified rating, and capacity or size when known.
  - **Resolved by:**
    - **User:** Annual dollar savings > Added heat-pump water-heater electricity > Certified existing and proposed product resolution [BR-CERTIFIED-PRODUCT-RESOLUTION] > Existing Model, if known
    - **User:** Annual dollar savings > Added heat-pump water-heater electricity > Certified existing and proposed product resolution [BR-CERTIFIED-PRODUCT-RESOLUTION] > Existing Capacity or Size Class, if known
    - **User:** Annual dollar savings > Added heat-pump water-heater electricity > Certified existing and proposed product resolution [BR-CERTIFIED-PRODUCT-RESOLUTION] > Selected Proposed Model, if known
    - **User:** Annual dollar savings > Added heat-pump water-heater electricity > Certified existing and proposed product resolution [BR-CERTIFIED-PRODUCT-RESOLUTION] > Proposed Capacity or Size Class, if known
- `linked_opportunity` - **Conditional:** Product, certification, class, or minimum-performance restriction when a Linked Opportunity supplies one. Applies only in the documented scenario.
  - **Resolved by:**
    - **Derived:** Annual dollar savings > Added heat-pump water-heater electricity > Certified existing and proposed product resolution [BR-CERTIFIED-PRODUCT-RESOLUTION] > Linked Opportunity
...
Do not use ComStock for this category because its published commercial service-water-heating coverage is incomplete.
...
- Decide whether RetroFi should keep Heat-pump water-heater resource switching at no estimate until this category-specific gate is resolved: Existing and proposed exact-product fixtures and deterministic resource selection.
