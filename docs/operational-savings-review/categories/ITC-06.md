...
|---|---|---|---|---|---|---|---|
| current_annual_input | resource-unit/year | Measured end use or user-confirmed bill allocation | annual_kwh or annual_therms plus User water-heating share | None | Direct input or formula | Avoided existing water-heating resource | NO_ESTIMATE |
| avoided_existing_resource | resource-unit/year | Measured end use or user-confirmed bill allocation | annual_kwh or annual_therms plus User water-heating share | None | Direct input or formula | Avoided existing water-heating resource | NO_ESTIMATE |
| η_existing | fraction and kWh-thermal/year | Exact existing product or measurement plus formula | User Existing Model or measured efficiency | None | E-CCMS-EXISTING-UNSUPPORTED: UNSUPPORTED | No reviewed retained historical export - No installed-population table or historical-retention proof | NO_ESTIMATE |
| annual_hot_water_load | fraction and kWh-thermal/year | Exact existing product or measurement plus formula | User Existing Model or measured efficiency | None | E-CCMS-EXISTING-UNSUPPORTED: UNSUPPORTED | No reviewed retained historical export - No installed-population table or historical-retention proof | NO_ESTIMATE |
| UEF_or_COP_proposed | ratio and kWh/year | Exact proposed product plus formula | User Selected Proposed Model | None | E-CCMS-CURRENT: UNVERIFIED<br>E-ENERGY-STAR-OTHER: UNVERIFIED | Product-specific analyst export and DOE test-result template - Product-specific fields are not pinned until an export and template fixture are reviewed<br>Commercial clothes washer, ice machine, cooking, and EVSE datasets - Product-specific field schemas are listed in the registry but have not all been captured as fixtures | NO_ESTIMATE |
| added_kWh | ratio and kWh/year | Exact proposed product plus formula | User Selected Proposed Model | None | E-CCMS-CURRENT: UNVERIFIED<br>E-ENERGY-STAR-OTHER: UNVERIFIED | Product-specific analyst export and DOE test-result template - Product-specific fields are not pinned until an export and template fixture are reviewed<br>Commercial clothes washer, ice machine, cooking, and EVSE datasets - Product-specific field schemas are listed in the registry but have not all been captured as fixtures | NO_ESTIMATE |
